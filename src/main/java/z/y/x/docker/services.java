...
public class services {
	...
	public int hashCode() {
		...
		result = prime * result + ((stop_grace_period == null) ? 0 : stop_grace_period.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (stdin_open != other.stdin_open)
			return false;
		if (stop_grace_period == null) {
			if (other.stop_grace_period != null)
				return false;
		} else if (!stop_grace_period.equals(other.stop_grace_period))
			return false;
		if (stop_signal == null) {
	...
	public String toString() {
		return "services [image=" + image + ", command=" + Arrays.toString(command) + ", deploy=" + deploy
				...
				+ ", stop_grace_period=" + stop_grace_period + ", cpu_count=" + cpu_count + ", cpu_percent="
				+ cpu_percent + ", cpus=" + cpus + ", cpu_shares=" + cpu_shares + ", cpu_quota=" + cpu_quota
				+ ", cpu_period=" + cpu_period + ", cpuset=" + cpuset + ", mem_limit=" + mem_limit + ", memswap_limit="
				+ memswap_limit + ", mem_reservation=" + mem_reservation + ", oom_score_adj=" + oom_score_adj
				+ ", oom_kill_disable=" + oom_kill_disable + ", shm_size=" + shm_size + "]";
	}
}
