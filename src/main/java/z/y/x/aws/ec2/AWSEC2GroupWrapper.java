...
public class AWSEC2GroupWrapper {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AWSEC2GroupWrapper other = (AWSEC2GroupWrapper) obj;
		if (connection == null) {
	...
	public String toString() {
		return "AWSEC2GroupWrapper [hosts=" + hosts + ", connection=" + connection + ", gather_facts=" + gather_facts
				+ ", tasks=" + tasks + "]";
	}
