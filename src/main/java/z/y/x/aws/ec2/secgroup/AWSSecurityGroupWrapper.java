...
public class AWSSecurityGroupWrapper {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AWSSecurityGroupWrapper other = (AWSSecurityGroupWrapper) obj;
		if (connection == null) {
	...
	public String toString() {
		return "AWSSecurityGroupWrapper [hosts=" + hosts + ", connection=" + connection + ", gather_facts="
				+ gather_facts + ", tasks=" + tasks + "]";
	}
