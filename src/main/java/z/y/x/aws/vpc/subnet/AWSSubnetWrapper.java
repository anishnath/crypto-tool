...
public class AWSSubnetWrapper {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AWSSubnetWrapper other = (AWSSubnetWrapper) obj;
		if (connection == null) {
	...
	public String toString() {
		return "AWSSubnetWrapper [hosts=" + hosts + ", connection=" + connection + ", gather_facts=" + gather_facts
				+ ", tasks=" + tasks + "]";
	}
