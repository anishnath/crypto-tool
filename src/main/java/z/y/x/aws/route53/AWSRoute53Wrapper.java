...
public class AWSRoute53Wrapper {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AWSRoute53Wrapper other = (AWSRoute53Wrapper) obj;
		if (connection == null) {
	...
	public String toString() {
		return "AWSRoute53Wrapper [hosts=" + hosts + ", connection=" + connection + ", gather_facts=" + gather_facts
				+ ", tasks=" + tasks + "]";
	}
