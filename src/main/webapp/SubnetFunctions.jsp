...
<script type="application/ld+json">
{
	...
	"description": "Online IP subnet calculator to calculate subnet ranges, network addresses, broadcast addresses, and available host addresses using CIDR notation.",
	...
	"keywords": "subnet calculator, cidr calculator, ip subnet, network calculator, subnet mask, network planning, network tools",
	"about": {
		"@type": "Thing",
		"name": "Network Planning",
		"description": "Subnet calculators help network administrators plan and design network architectures by calculating subnet ranges and available host addresses."
	},
	"audience": {
		"@type": "Audience",
