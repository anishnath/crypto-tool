...
<%@ include file="../../components/header.jsp" %>
                    ...
                    <style>
                        ...
                        .meta-pill.difficulty-easy {
                            background: rgba(34, 197, 94, 0.15);
                            color: #22c55e;
                        }

                        .meta-pill.difficulty-medium {
                            background: rgba(245, 158, 11, 0.15);
                            color: #f59e0b;
                        }

                        .meta-pill.difficulty-hard {
                        ...
                        /* Dark mode */
                        [data-theme="dark"] .meta-pill.chapter {
                            background: rgba(99, 102, 241, 0.2);
                            color: #a5b4fc;
                        }

                        [data-theme="dark"] .meta-pill.exercise {
                            background: rgba(59, 130, 246, 0.2);
                            color: #93c5fd;
                        }

                        [data-theme="dark"] .meta-pill.type {
                            background: rgba(148, 163, 184, 0.15);
                            color: #94a3b8;
                        }

                        [data-theme="dark"] .meta-pill.difficulty-easy {
                            background: rgba(34, 197, 94, 0.2);
                            color: #86efac;
                        }

                        [data-theme="dark"] .meta-pill.difficulty-medium {
                            background: rgba(245, 158, 11, 0.2);
                            color: #fcd34d;
                        }

                        [data-theme="dark"] .meta-pill.difficulty-hard {
                            background: rgba(239, 68, 68, 0.2);
                            color: #fca5a5;
                        }

                        [data-theme="dark"] .meta-pill.marks {
                            background: rgba(139, 92, 246, 0.2);
                            color: #c4b5fd;
                        }

                        [data-theme="dark"] .meta-pill.has-plot {
                            background: rgba(99, 102, 241, 0.2);
                            color: #a5b4fc;
                        }
                    ...
                    <div class="container">
                        <nav class="breadcrumb">
                            ...
                            <span class="breadcrumb-separator">/</span>
                            <a
                                href="<%=request.getContextPath()%>/exams/books/ncert/<%= bookClass %>/<%= bookPart %>/<%= chapterSlug %>/">
                                <%= chapterName %>
                            </a>
                            <span class="breadcrumb-separator">/</span>
                            <span class="breadcrumb-current" id="breadcrumbQuestion">
                                <%= isMisc ? "Additional" : "Question" %>
                                    <%= questionNum %>
                            </span>
                        </nav>
                    </div>
                    ...
                    <script>
                                                ...
                                                .then(function (sketchData) {
                                                    loadP5(function () {
                                                        for (var i = 0; i < sketchTargets.length; i++) {
                                                            ...
                                                            if (!config) continue;
                                                            var SketchLib = (BOOK_CLASS === 'class-11') ? PhysicsSketchesClass11 : PhysicsSketches;
                                                            if (SketchLib) SketchLib.render(el, config.type, config.params || {});
                                                        }
                                                    });
                                                })
                        ...
                        function loadP5(callback) {
                            ...
                            var scriptName = (bookClass === 'class-11') ? 'physics-sketches-class-11.js' : 'physics-sketches.js';
                            var scriptPath = '<%=request.getContextPath()%>/exams/books/ncert/' + scriptName;
