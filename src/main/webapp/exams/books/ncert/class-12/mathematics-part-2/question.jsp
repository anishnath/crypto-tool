...
<%
    ...
    chapterMap.put("integrals", new String[]{"7", "Integrals"});
    chapterMap.put("application-of-integrals", new String[]{"8", "Application of Integrals"});
    chapterMap.put("differential-equations", new String[]{"9", "Differential Equations"});
    chapterMap.put("vector-algebra", new String[]{"10", "Vector Algebra"});
    chapterMap.put("three-dimensional-geometry", new String[]{"11", "Three Dimensional Geometry"});
    chapterMap.put("linear-programming", new String[]{"12", "Linear Programming"});
    chapterMap.put("probability", new String[]{"13", "Probability"});
    ...
    // Regular: ex-6-1-q1 -> Exercise 6.1, Q1
    ...
    try {
        String jsonPath = application.getRealPath("/exams/books/ncert/class-12/mathematics-part-2/data/chapters.json");
    ...
    if (questionPlainText != null && !questionPlainText.isEmpty()) {
        ...
        pageTitle = truncatedQuestion + " | NCERT Class 12 " + chapterName + " " + exerciseLabel + " " + questionNum;

        String questionForMeta = questionPlainText.length() > 120 ? questionPlainText.substring(0, 120) : questionPlainText;
        metaDesc = questionForMeta + " - Step-by-step NCERT Class 12 " + chapterName + " solution with explanation.";
    } else {
        pageTitle = "NCERT Class 12 Maths " + exerciseLabel + " " + questionNum + " Solution | " + chapterName;
        metaDesc = "Step-by-step solution for NCERT Class 12 Mathematics " + chapterName + " " + exerciseLabel + " " + questionNum + " with hints, detailed explanation and final answer.";
    }

    request.setAttribute("pageTitle", pageTitle);
    request.setAttribute("pageDescription", metaDesc);
    request.setAttribute("canonicalUrl", "https://8gwifi.org/exams/books/ncert/class-12/mathematics-part-2/" + chapterSlug + "/" + questionSlug + ".jsp");
%>
...
<div class="container">
    <nav class="breadcrumb">
        ...
        <span class="breadcrumb-separator">/</span>
        <a href="<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-2/<%= chapterSlug %>/"><%= chapterName %></a>
        <span class="breadcrumb-separator">/</span>
...
(function() {
    ...
    fetch('<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-2/data/chapters.json')
        ...
        .then(function(data) {
            ...
            document.title = questionText + '... | NCERT Class 12 ' + currentQuestion.exercise + ' ' + currentQuestion.question_number;

            // Update meta description
            var metaDesc = currentQuestion.question_plain.substring(0, 120) +
                           ' - Step-by-step NCERT Class 12 ' + CHAPTER_NAME + ' solution with explanation.';
            ...
            if (currentQuestion.visual_content && currentQuestion.visual_content.has_diagram && currentQuestion.visual_content.diagram_svg) {
                ...
                html += '<img src="<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-2/diagrams/' + currentQuestion.visual_content.diagram_svg + '" ';
            ...
            if (currentQuestion.interactive_plot) {
                var plotSlugs = Array.isArray(currentQuestion.interactive_plot) ? currentQuestion.interactive_plot : [currentQuestion.interactive_plot];
                var plotFile = '<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-2/data/plots/ch' + CHAPTER_NUM + '-plots.json';
                fetch(plotFile)
                    .then(function(r) {
...
// --- Extended Plot Item Builder (supports vector, polar, closed) ---
...
function injectQASchema(q) {
    ...
    var schema = {
        ...
        "mainEntity": {
            "@type": "Question",
            "name": "NCERT Class 12 Maths " + q.exercise + " " + q.question_number + ": " + questionText.substring(0, 200),
            "text": questionText,
            "answerCount": 1,
    ...
    var breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            {"@type": "ListItem", "position": 4, "name": "Class 12 Maths Part 2", "item": "https://8gwifi.org/exams/books/ncert/class-12/mathematics-part-2/"},
            {"@type": "ListItem", "position": 5, "name": "<%= chapterName %>", "item": "https://8gwifi.org/exams/books/ncert/class-12/mathematics-part-2/<%= chapterSlug %>/"},
