...
<%
    ...
    chapterMap.put("integrals", new String[]{"7", "Integrals", "NCERT Class 12 Maths Chapter 7 Integrals solutions. Indefinite integrals, integration by substitution, partial fractions, by parts, definite integrals, properties of definite integrals."});
    chapterMap.put("application-of-integrals", new String[]{"8", "Application of Integrals", "NCERT Class 12 Maths Chapter 8 Application of Integrals solutions. Area under curves, area between two curves, ellipse and circle areas using integration."});
    chapterMap.put("differential-equations", new String[]{"9", "Differential Equations", "NCERT Class 12 Maths Chapter 9 Differential Equations solutions. Order and degree, general and particular solutions, variable separable, homogeneous, linear differential equations."});
    chapterMap.put("vector-algebra", new String[]{"10", "Vector Algebra", "NCERT Class 12 Maths Chapter 10 Vector Algebra solutions. Types of vectors, addition, scalar multiplication, dot product, cross product, section formula, scalar triple product."});
    chapterMap.put("three-dimensional-geometry", new String[]{"11", "Three Dimensional Geometry", "NCERT Class 12 Maths Chapter 11 Three Dimensional Geometry solutions. Direction cosines, equations of a line, angle between lines, shortest distance, equation of a plane."});
    chapterMap.put("linear-programming", new String[]{"12", "Linear Programming", "NCERT Class 12 Maths Chapter 12 Linear Programming solutions. Linear programming problems, graphical method, feasible region, optimal solutions, corner point method."});
    chapterMap.put("probability", new String[]{"13", "Probability", "NCERT Class 12 Maths Chapter 13 Probability solutions. Conditional probability, multiplication theorem, independent events, Bayes theorem, random variables, Bernoulli trials, binomial distribution."});

    // Get chapter from URL path
    String requestURI = request.getRequestURI();
    String chapterSlug = "";

    // Extract chapter slug from path like /exams/books/ncert/class-12/mathematics-part-2/integrals/
    String[] pathParts = requestURI.split("/");
    for (int i = 0; i < pathParts.length; i++) {
        if ("mathematics-part-2".equals(pathParts[i]) && i + 1 < pathParts.length) {
    ...
    String chapterNum = chapterData != null ? chapterData[0] : "7";
    ...
    request.setAttribute("canonicalUrl", "https://8gwifi.org/exams/books/ncert/class-12/mathematics-part-2/" + chapterSlug + "/");
...
<div class="container">
    <nav class="breadcrumb">
        ...
        <span class="breadcrumb-separator">/</span>
        <a href="<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-2/">Class 12 Maths Part 2</a>
        <span class="breadcrumb-separator">/</span>
...
<div class="three-col-layout">
    ...
    <main class="main-content-area">
        ...
        <section class="chapter-hero">
            ...
            <p>NCERT Class 12 Mathematics Part 2 Solutions</p>
...
<noscript>
    <div class="seo-content" style="padding: 20px;">
        <h2>NCERT Class 12 Mathematics Part 2 - Chapter <%= chapterNum %>: <%= chapterName %> Solutions</h2>
        <p><%= metaDesc %></p>
        <p>This page contains complete solutions for all exercises in Chapter <%= chapterNum %> (<%= chapterName %>) from NCERT Class 12 Mathematics Part 2 textbook. Each question includes step-by-step solutions, hints, and detailed explanations.</p>
        ...
        <ul>
            <li><a href="/exams/books/ncert/class-12/mathematics-part-2/integrals/">Chapter 7: Integrals</a></li>
            <li><a href="/exams/books/ncert/class-12/mathematics-part-2/application-of-integrals/">Chapter 8: Application of Integrals</a></li>
            <li><a href="/exams/books/ncert/class-12/mathematics-part-2/differential-equations/">Chapter 9: Differential Equations</a></li>
            <li><a href="/exams/books/ncert/class-12/mathematics-part-2/vector-algebra/">Chapter 10: Vector Algebra</a></li>
            <li><a href="/exams/books/ncert/class-12/mathematics-part-2/three-dimensional-geometry/">Chapter 11: Three Dimensional Geometry</a></li>
            <li><a href="/exams/books/ncert/class-12/mathematics-part-2/linear-programming/">Chapter 12: Linear Programming</a></li>
            <li><a href="/exams/books/ncert/class-12/mathematics-part-2/probability/">Chapter 13: Probability</a></li>
        </ul>
    </div>
</noscript>
...
<script type="application/ld+json">
{
    ...
    "url": "https://8gwifi.org/exams/books/ncert/class-12/mathematics-part-2/<%= chapterSlug %>/",
    "provider": {
        "@type": "Organization",
        "name": "8gwifi.org",
...
(function() {
    ...
    // Load chapter data
    fetch('<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-2/data/chapters.json')
                ...
                questions.forEach(function(q, qIdx) {
                    ...
                    if (q.visual_content && q.visual_content.has_diagram) {
                        ...
                        if (q.visual_content.diagram_svg) {
                            ...
                            html += '<img src="<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-2/diagrams/' + q.visual_content.diagram_svg + '" ';
...
// --- Interactive Plot Support (Extended for Part 2: vector, polar, closed) ---
var _plotDataCache = {};
...
function getPlotFile() {
    return '<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-2/data/plots/ch' + '<%= chapterNum %>' + '-plots.json';
}
...
function buildPlotItem(d) {
    ...
    } else if (d.fnType === 'polar') {
        item.fnType = 'polar';
        item.r = d.r;
        if (d.graphType) item.graphType = d.graphType;
    } else if (d.fnType === 'vector') {
        item.fnType = 'vector';
        item.vector = d.vector;
        if (d.offset) item.offset = d.offset;
        item.graphType = d.graphType || 'polyline';
    } else {
        item.fn = d.fn;
            ...
            loadFunctionPlot(function() {
                try {
                    var plotConfig = {
                        ...
                        data: config.data.map(buildPlotItem),
