...
<%
    ...
    chapterMap.put("relations-and-functions", new String[]{"1", "Relations and Functions"});
    chapterMap.put("inverse-trigonometric-functions", new String[]{"2", "Inverse Trigonometric Functions"});
    chapterMap.put("matrices", new String[]{"3", "Matrices"});
    chapterMap.put("determinants", new String[]{"4", "Determinants"});
    chapterMap.put("continuity-and-differentiability", new String[]{"5", "Continuity and Differentiability"});
    chapterMap.put("applications-of-derivatives", new String[]{"6", "Applications of Derivatives"});
    ...
    try {
        String jsonPath = application.getRealPath("/exams/books/ncert/class-12/mathematics-part-1/data/chapters.json");
    ...
    request.setAttribute("canonicalUrl", "https://8gwifi.org/exams/books/ncert/class-12/mathematics-part-1/" + chapterSlug + "/" + questionSlug + ".jsp");
%>
...
<div class="container">
    <nav class="breadcrumb">
        ...
        <span class="breadcrumb-separator">/</span>
        <a href="<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-1/<%= chapterSlug %>/"><%= chapterName %></a>
        <span class="breadcrumb-separator">/</span>
    ...
    fetch('<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-1/data/chapters.json')
        ...
        .then(function(data) {
            ...
            if (currentQuestion.visual_content && currentQuestion.visual_content.has_diagram && currentQuestion.visual_content.diagram_svg) {
                ...
                html += '<img src="<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-1/diagrams/' + currentQuestion.visual_content.diagram_svg + '" ';
            ...
            if (currentQuestion.interactive_plot) {
                var plotSlugs = Array.isArray(currentQuestion.interactive_plot) ? currentQuestion.interactive_plot : [currentQuestion.interactive_plot];
                var plotFile = '<%=request.getContextPath()%>/exams/books/ncert/class-12/mathematics-part-1/data/plots/ch' + CHAPTER_NUM + '-plots.json';
                fetch(plotFile)
                    .then(function(r) {
...
function injectQASchema(q) {
    ...
    var breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            {"@type": "ListItem", "position": 4, "name": "Class 12 Maths Part 1", "item": "https://8gwifi.org/exams/books/ncert/class-12/mathematics-part-1/"},
            {"@type": "ListItem", "position": 5, "name": "<%= chapterName %>", "item": "https://8gwifi.org/exams/books/ncert/class-12/mathematics-part-1/<%= chapterSlug %>/"},
