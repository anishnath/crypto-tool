...
<%
    ...
    chapterMap.put("number-systems", new String[]{"1", "Number Systems", "NCERT Class 9 Maths Chapter 1 Number Systems solutions. Learn rational, irrational numbers, real number line, laws of exponents with step-by-step answers."});
    chapterMap.put("polynomials", new String[]{"2", "Polynomials", "NCERT Class 9 Maths Chapter 2 Polynomials solutions. Degree, zeroes, factorization, remainder theorem, algebraic identities explained step-by-step."});
    chapterMap.put("coordinate-geometry", new String[]{"3", "Coordinate Geometry", "NCERT Class 9 Maths Chapter 3 Coordinate Geometry solutions. Cartesian plane, plotting points, quadrants with detailed explanations."});
    chapterMap.put("linear-equations-in-two-variables", new String[]{"4", "Linear Equations in Two Variables", "NCERT Class 9 Maths Chapter 4 Linear Equations solutions. Graph linear equations, find solutions, understand slope-intercept form."});
    chapterMap.put("introduction-to-euclids-geometry", new String[]{"5", "Introduction to Euclid's Geometry", "NCERT Class 9 Maths Chapter 5 Euclid's Geometry solutions. Axioms, postulates, theorems explained with proofs."});
    chapterMap.put("lines-and-angles", new String[]{"6", "Lines and Angles", "NCERT Class 9 Maths Chapter 6 Lines and Angles solutions. Parallel lines, transversals, angle relationships with proofs."});
    chapterMap.put("triangles", new String[]{"7", "Triangles", "NCERT Class 9 Maths Chapter 7 Triangles solutions. Congruence criteria SAS, ASA, SSS, RHS with detailed proofs."});
    chapterMap.put("quadrilaterals", new String[]{"8", "Quadrilaterals", "NCERT Class 9 Maths Chapter 8 Quadrilaterals solutions. Properties of parallelograms, rectangles, rhombus, squares."});
    chapterMap.put("areas-of-parallelograms-and-triangles", new String[]{"9", "Areas of Parallelograms and Triangles", "NCERT Class 9 Maths Chapter 9 Areas solutions. Area theorems, triangles on same base, parallelogram properties."});
    chapterMap.put("circles", new String[]{"10", "Circles", "NCERT Class 9 Maths Chapter 10 Circles solutions. Chords, arcs, angles subtended, cyclic quadrilaterals with proofs."});
    chapterMap.put("constructions", new String[]{"11", "Constructions", "NCERT Class 9 Maths Chapter 11 Constructions solutions. Bisect angles, construct triangles with compass and ruler."});
    chapterMap.put("herons-formula", new String[]{"12", "Heron's Formula", "NCERT Class 9 Maths Chapter 12 Heron's Formula solutions. Calculate triangle area using sides, applications to quadrilaterals."});
    chapterMap.put("surface-areas-and-volumes", new String[]{"13", "Surface Areas and Volumes", "NCERT Class 9 Maths Chapter 13 Surface Areas and Volumes solutions. Cube, cuboid, cylinder, cone, sphere formulas."});
    chapterMap.put("statistics", new String[]{"14", "Statistics", "NCERT Class 9 Maths Chapter 14 Statistics solutions. Mean, median, mode, frequency distribution, graphical representation."});
    chapterMap.put("probability", new String[]{"15", "Probability", "NCERT Class 9 Maths Chapter 15 Probability solutions. Experimental probability, theoretical probability, random experiments."});

    // Get chapter from URL path
    String requestURI = request.getRequestURI();
    String chapterSlug = "";

    // Extract chapter slug from path like /exams/books/ncert/class-9/mathematics/circles/
    ...
    String metaDesc = chapterData != null ? chapterData[2] : "NCERT Class 9 Maths solutions with step-by-step explanations.";

    request.setAttribute("pageTitle", "NCERT Class 9 Maths Chapter " + chapterNum + " " + chapterName + " Solutions");
    request.setAttribute("pageDescription", metaDesc);
    request.setAttribute("canonicalUrl", "https://8gwifi.org/exams/books/ncert/class-9/mathematics/" + chapterSlug + "/");
...
<style>
    ...
    /* Dark mode: make toggle buttons, badges, and labels more visible */
...
<div class="three-col-layout">
    ...
    <main class="main-content-area">
        ...
        <section class="chapter-hero">
            ...
            <p>NCERT Class 9 Mathematics Solutions</p>
...
<noscript>
    <div class="seo-content" style="padding: 20px;">
        <h2>NCERT Class 9 Mathematics - Chapter <%= chapterNum %>: <%= chapterName %> Solutions</h2>
        <p><%= metaDesc %></p>
        <p>This page contains complete solutions for all exercises in Chapter <%= chapterNum %> (<%= chapterName %>) from NCERT Class 9 Mathematics textbook. Each question includes step-by-step solutions, hints, and detailed explanations.</p>

        <h3>Topics Covered in <%= chapterName %>:</h3>
        <ul>
            <% if ("10".equals(chapterNum)) { %>
            <li>Circle and its related terms: radius, diameter, chord, arc, secant, sector, segment</li>
            <li>Angle subtended by a chord at a point</li>
            <li>Perpendicular from the centre to a chord</li>
            <li>Circle through three points</li>
            <li>Equal chords and their distances from the centre</li>
            <li>Angle subtended by an arc of a circle</li>
            <li>Cyclic quadrilaterals</li>
            <% } else if ("14".equals(chapterNum)) { %>
            <li>Collection and presentation of data</li>
            <li>Graphical representation of data - Bar graphs, Histograms, Frequency polygons</li>
            <li>Measures of central tendency - Mean, Median, Mode</li>
            <% } else if ("7".equals(chapterNum)) { %>
            <li>Congruence of triangles</li>
            <li>Criteria for congruence: SAS, ASA, AAS, SSS, RHS</li>
            <li>Properties of triangles</li>
            <li>Inequalities in triangles</li>
            <% } else { %>
        ...
        <ul>
            <li><a href="/exams/books/ncert/class-9/mathematics/number-systems/">Chapter 1: Number Systems</a></li>
            <li><a href="/exams/books/ncert/class-9/mathematics/polynomials/">Chapter 2: Polynomials</a></li>
            <li><a href="/exams/books/ncert/class-9/mathematics/triangles/">Chapter 7: Triangles</a></li>
            <li><a href="/exams/books/ncert/class-9/mathematics/circles/">Chapter 10: Circles</a></li>
            <li><a href="/exams/books/ncert/class-9/mathematics/statistics/">Chapter 14: Statistics</a></li>
        </ul>
    </div>
</noscript>
...
<script type="application/ld+json">
{
    ...
    "@type": "Course",
    "name": "NCERT Class 9 Maths Chapter <%= chapterNum %> - <%= chapterName %>",
    "description": "<%= metaDesc %>",
    "url": "https://8gwifi.org/exams/books/ncert/class-9/mathematics/<%= chapterSlug %>/",
    "provider": {
        "@type": "Organization",
        "name": "8gwifi.org",
                ...
                questions.forEach(function(q, qIdx) {
                    ...
                    if (q.visual_content && q.visual_content.has_diagram) {
                        ...
                        if (q.visual_content.diagram_svg) {
                            ...
                            html += '<img src="<%=request.getContextPath()%>/exams/books/ncert/class-9/mathematics/diagrams/' + q.visual_content.diagram_svg + '" ';
...
function generateFAQSchema(questions) {
    var faqItems = questions.map(function(q) {
        ...
        return {
            "@type": "Question",
            "name": "NCERT Class 9 Maths " + q.exercise + " " + q.question_number + ": " + questionText.substring(0, 100) + (questionText.length > 100 ? '...' : ''),
            "acceptedAnswer": {
                "@type": "Answer",
