<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ include file="physics-config.jsp" %>
        <% String ncertLabel="NCERT " + bookClassLabel + " " + subject; String metaDesc=chapterMetaDesc !=null &&
            !chapterMetaDesc.isEmpty() ? chapterMetaDesc : ncertLabel + " solutions with step-by-step explanations." ;
            ...
            + "/" + chapterSlug + "/" ); // Pass to JavaScript request.setAttribute("chapterSlug", chapterSlug);
            request.setAttribute("chapterNum", chapterNum); request.setAttribute("chapterName", chapterName); %>
            <%@ include file="../../components/header.jsp" %>
                ...
                <style>
                    ...
                    .meta-badge.type-proof {
                        background: rgba(139, 92, 246, 0.15);
                        color: #8b5cf6;
                    }

                    .meta-badge.type-numerical {
                    ...
                    [data-theme="dark"] .meta-badge.type-proof {
                        background: rgba(139, 92, 246, 0.2);
                        color: #a78bfa;
                    }

                    [data-theme="dark"] .meta-badge.type-numerical {
                        background: rgba(59, 130, 246, 0.2);
                        color: #93c5fd;
                    }

                    [data-theme="dark"] .meta-badge.type-mcq {
                        background: rgba(34, 197, 94, 0.2);
                        color: #86efac;
                    }

                    [data-theme="dark"] .meta-badge.difficulty-easy {
                        background: rgba(34, 197, 94, 0.2);
                        color: #86efac;
                    }

                    [data-theme="dark"] .meta-badge.difficulty-medium {
                        background: rgba(245, 158, 11, 0.2);
                        color: #fcd34d;
                    }

                    [data-theme="dark"] .meta-badge.difficulty-hard {
                        background: rgba(239, 68, 68, 0.2);
                        color: #fca5a5;
                    }

                    [data-theme="dark"] .meta-badge.has-plot {
                        background: rgba(99, 102, 241, 0.2);
                        color: #a5b4fc;
                    }
                    ...
                    [data-theme="dark"] .calc-slider-value {
                        color: #a5b4fc;
                    }
                ...
                <div class="container">
                    <nav class="breadcrumb">
                        ...
                        <span class="breadcrumb-separator">/</span>
                        <a href="<%=request.getContextPath()%>/exams/books/ncert/<%= bookClass %>/<%= bookPart %>/">
                            <%= fullLabel %>
                        </a>
                        <span class="breadcrumb-separator">/</span>
                ...
                <div class="three-col-layout">
                    ...
                    <main class="main-content-area">
                        ...
                        <section class="chapter-hero">
                            <h1>Chapter <%= chapterNum %>: <%= chapterName %>
                            </h1>
                ...
                <noscript>
                    <div class="seo-content" style="padding: 20px;">
                        ...
                        <p>This page contains complete solutions for all exercises in Chapter <%= chapterNum %> (<%=
                                    chapterName %>) from NCERT <%= fullLabel %> textbook. Each question includes
                                        step-by-step solutions, hints, and detailed explanations.</p>
                        ...
                        <p><strong>Looking for specific questions?</strong> Enable JavaScript to view all questions with
                            interactive solutions, diagrams, and hints.</p>

                        <h3>Related Chapters:</h3>
                        <ul>
                            <% for (Map.Entry<String, String[]> entry : chapterMap.entrySet()) { %>
                                <li><a
                                        href="/exams/books/ncert/<%= bookClass %>/<%= bookPart %>/<%= entry.getKey() %>/">Chapter
        ...
        "courseWorkload": "PT1H"
                ...
                <script>
                    ...
                    function loadP5(callback) {
                        ...
                        // Determine which physics sketches library to load based on class
                        var physicsSketchesFile = '<%= bookClass %>' === 'class-11'
                            ? '<%=request.getContextPath()%>/exams/books/ncert/physics-sketches-class-11.js'
                            : '<%=request.getContextPath()%>/exams/books/ncert/physics-sketches.js';

                        console.log('Loading p5.js for class:', '<%= bookClass %>', 'File:', physicsSketchesFile);

                        if (_p5Loaded && !_physicsSketchesLoaded) {
                            var s2 = document.createElement('script');
                            s2.src = physicsSketchesFile;
                    ...
                    function renderP5Sketches(targets) {
                        ...
                        function doRender(sketchData) {
                            ...
                            loadP5(function () {
                                // Use the correct global object based on class
                                var SketchLib = '<%= bookClass %>' === 'class-11' ? PhysicsSketchesClass11 : PhysicsSketches;
                                ...
                                for (var i = 0; i < targets.length; i++) {
                                    ...
                                    if (!config) continue;
                                    SketchLib.render(el, config.type, config.params || {});
