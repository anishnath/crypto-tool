    ...
    <script type="application/ld+json">
{
  ...
  "name" : "DMARC record Checker | DMARC record Tester  DMARC Analyze",
  ...
  "applicationCategory" : [ "DMARC record Checker ", "DMARC record Tester", " DMARC Analyze", "dmarc query online", "about dmarc"],
  "downloadUrl" : "https://8gwifi.org/dmarc.jsp",
  "operatingSystem" : "Linux,Unix,Windows,Redhat,RHEL,Fedora,Ubuntu",
  "requirements" : "DMARC record Checker | DMARC record Tester  DMARC Analyze",
