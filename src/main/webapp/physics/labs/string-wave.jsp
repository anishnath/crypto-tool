...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Vibrating String — Wave Equation Simulator" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Interactive vibrating string simulation solving the wave equation PDE. Pluck, sine modes, pulse. Adjust tension, density, damping. See standing waves and harmonics. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/string-wave.jsp" />
    <jsp:param name="toolKeywords" value="vibrating string, wave equation, PDE simulation, standing waves, harmonics, string physics, Fourier series, wave speed" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="High School, Undergraduate" />
    <jsp:param name="teaches" value="Wave equation PDE, standing waves, harmonics, vibrating string, finite differences, Fourier analysis" />
    <jsp:param name="hasSteps" value="true" />
    <jsp:param name="howToSteps" value="Pluck the string|Select Pluck preset to see a triangle wave decompose into harmonics,Pure modes|Select Sine preset to see a single standing wave mode,Watch pulse|Select Pulse to see a wave packet bounce between endpoints,Adjust tension|Higher tension means faster waves and higher pitch" />
    <jsp:param name="faq1q" value="What determines the pitch of a vibrating string?" />
    <jsp:param name="faq1a" value="The fundamental frequency is f = sqrt(T/rho) / (2L) where T is tension, rho is linear density, and L is string length. Higher tension or shorter string means higher pitch. Thicker heavier strings vibrate slower giving lower pitch. This is why bass guitar strings are thick and tuning pegs adjust tension." />
    <jsp:param name="faq2q" value="What are standing waves and harmonics?" />
    <jsp:param name="faq2a" value="A string fixed at both ends supports standing waves at frequencies f_n = n times c divided by 2L. The fundamental n=1 is the lowest pitch. Higher harmonics give richer sound. A plucked string excites all harmonics simultaneously which is why it sounds rich compared to a pure sine tone." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  ...
  <h1 class="lab-title">Vibrating String</h1>
...
import { StringWaveSim } from './js/sims/string-wave.js';

const lab = createLab(StringWaveSim, {
...
document.getElementById('labInfo').innerHTML = StringWaveSim.info || '';
</script>
