...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Car Suspension Simulator — Damping Ratio ζ Explained" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Drive a car over bumps, washboard roads, and potholes. See how the damping ratio controls ride quality. Compare underdamped, critically damped, and overdamped suspensions. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/car-suspension.jsp" />
    <jsp:param name="toolKeywords" value="car suspension, damping ratio, quarter car model, spring damper, critically damped, underdamped, overdamped, resonance, ride quality, AP physics" />
    ...
    <jsp:param name="teaches" value="damping ratio, critically damped, underdamped, overdamped, forced oscillation, resonance, quarter car model, suspension design" />
    <jsp:param name="faq1q" value="What is the damping ratio and why does it matter for car suspensions?" />
    <jsp:param name="faq1a" value="The damping ratio zeta equals b divided by 2 times the square root of m times k. When zeta is less than 1 the suspension is underdamped and the car bounces after a bump. When zeta equals 1 it is critically damped and settles fastest without bouncing. When zeta is greater than 1 it is overdamped and returns slowly. Real cars typically use zeta between 0.2 and 0.7. Comfort sedans use 0.2 to 0.35 while sports and performance cars use 0.4 to 0.7." />
    <jsp:param name="faq2q" value="What is washboard resonance in a car suspension?" />
    <jsp:param name="faq2a" value="Washboard resonance occurs when a car drives over regularly spaced bumps at a speed where the bump frequency matches the suspension natural frequency. The natural frequency is the square root of k over m divided by 2 pi. At resonant speed the body oscillations grow dramatically especially with low damping. This is why shock absorbers are critical for safety." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  ...
  <h1 class="lab-title">Car Suspension (Quarter-Car Model)</h1>
  <div id="labTabs"></div>
  <div class="lab-grid">
...
import { CarSuspensionSim } from './js/sims/car-suspension.js';
const lab = createLab(CarSuspensionSim, {
...
document.getElementById('labInfo').innerHTML = CarSuspensionSim.info || '';
</script>
<script>
(function(){
