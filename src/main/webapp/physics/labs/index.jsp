...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Physics Labs — 35 Interactive Simulations" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="35 free interactive physics simulations. Drag pendulums, collide billiard balls, watch chaos unfold, explore wave equations. All run in your browser with no signup required." />
    ...
    <jsp:param name="toolFeatures" value="35 interactive simulations,Drag-and-drop physics,Real-time graphs and energy plots,Phase space visualization,Direction field overlays,Export CSV data for lab reports,Screenshot sim and graph,Dark and light themes,No signup required,100% client-side" />
    <jsp:param name="faq1q" value="Are these physics simulations free?" />
    <jsp:param name="faq1a" value="Yes all 35 simulations are completely free. No registration no payment no limits. They run entirely in your browser using JavaScript. Your data never leaves your device." />
...
<script type="application/ld+json">
{
  ...
  "@type": "CollectionPage",
  "name": "Physics Labs",
  "description": "35 free interactive physics simulations",
  ...
  "mainEntity": {
    ...
    "itemListElement": [
      ...
      {"@type":"ListItem","position":20,"name":"Vertical Spring","url":"https://8gwifi.org/physics/labs/vertical-spring.jsp"},
      {"@type":"ListItem","position":21,"name":"Series vs Parallel Springs","url":"https://8gwifi.org/physics/labs/series-parallel-springs.jsp"},
      {"@type":"ListItem","position":22,"name":"Drop Mass","url":"https://8gwifi.org/physics/labs/drop-mass.jsp"},
      {"@type":"ListItem","position":23,"name":"Bungee Jump","url":"https://8gwifi.org/physics/labs/bungee.jsp"},
      {"@type":"ListItem","position":24,"name":"Spring on Incline","url":"https://8gwifi.org/physics/labs/spring-incline.jsp"},
      {"@type":"ListItem","position":25,"name":"Spring Pendulum","url":"https://8gwifi.org/physics/labs/spring-pendulum.jsp"},
      {"@type":"ListItem","position":26,"name":"Pulley-Spring Scale","url":"https://8gwifi.org/physics/labs/pulley-scale.jsp"},
      {"@type":"ListItem","position":27,"name":"Circuit Simulator","url":"https://8gwifi.org/physics/labs/circuit-simulator.jsp"},
...
<div class="labs-cat">
  ...
  <div class="labs-grid">
    ...
    <a href="bullet-block.jsp" class="lab-card">
      <div class="lab-card-icon" style="background:linear-gradient(135deg,#EF4444,#F59E0B);">
        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><rect x="1" y="9" width="3" height="6" fill="#475569" stroke="none"/><line x1="4" y1="12" x2="8" y2="12" stroke-dasharray="1.5 1" stroke="#06B6D4"/><rect x="10" y="8" width="6" height="8" rx="1" fill="#8B5CF6" stroke="none"/><circle cx="20" cy="12" r="1.5" fill="#EF4444" stroke="none"/><line x1="18" y1="12" x2="16" y2="12" stroke="#EF4444" stroke-width="1.5"/><line x1="22" y1="12" x2="20" y2="12" stroke="#EF4444" stroke-dasharray="1 1"/></svg>
      </div>
      <div class="lab-card-body">
        <h3>Bullet–Block–Spring</h3>
        <p>99% of bullet energy lost — where did it go?</p>
        <div class="card-badges"><span class="card-badge badge-drag">Drag</span><span class="card-badge badge-new">New</span></div>
      </div>
    </a>
    ...
    <a href="bungee.jsp" class="lab-card">
      ...
      <div class="lab-card-body">
        <h3>Bungee Jump</h3>
        <p>Three-phase jump: free fall, bungee engaged, slack bounce</p>
        <div class="card-badges"><span class="card-badge badge-drag">Drag</span><span class="card-badge badge-new">New</span></div>
      </div>
    </a>

    <a href="spring-incline.jsp" class="lab-card">
      <div class="lab-card-icon" style="background:linear-gradient(135deg,#06B6D4,#22C55E);">
        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><line x1="2" y1="20" x2="20" y2="6"/><line x1="20" y1="6" x2="20" y2="20"/><line x1="20" y1="20" x2="2" y2="20"/><rect x="10" y="11" width="4" height="3" rx="0.5" fill="#8B5CF6" stroke="none" transform="rotate(-35 12 12.5)"/><line x1="4" y1="18" x2="9" y2="13" stroke-dasharray="1.5 1" stroke="#06B6D4"/></svg>
      </div>
      <div class="lab-card-body">
        <h3>Spring on Incline</h3>
        <p>Period independent of ramp angle — only equilibrium shifts</p>
        <div class="card-badges"><span class="card-badge badge-drag">Drag</span><span class="card-badge badge-new">New</span></div>
      </div>
    </a>

    <a href="spring-pendulum.jsp" class="lab-card">
      <div class="lab-card-icon" style="background:linear-gradient(135deg,#8B5CF6,#06B6D4);">
        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><line x1="12" y1="2" x2="12" y2="4"/><line x1="8" y1="2" x2="16" y2="2" stroke-width="3"/><line x1="12" y1="4" x2="12" y2="12" stroke-dasharray="2 1" stroke="#06B6D4"/><circle cx="12" cy="14" r="2.5" fill="#8B5CF6" stroke="none"/><path d="M12 4 Q16 8 14 14" fill="none" stroke="#F59E0B" stroke-width="1" stroke-dasharray="2 2"/></svg>
      </div>
      <div class="lab-card-body">
    ...
    <a href="piston.jsp" class="lab-card">
      <div class="lab-card-icon" style="background:linear-gradient(135deg,#F59E0B,#06B6D4);">
        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><rect x="7" y="2" width="10" height="10" rx="1" fill="#8B5CF6" stroke="none"/><line x1="7" y1="2" x2="7" y2="12"/><line x1="17" y1="2" x2="17" y2="12"/><line x1="7" y1="2" x2="17" y2="2"/><circle cx="12" cy="10" r="0.8" fill="#CBD5E1"/><line x1="12" y1="10" x2="14" y2="18" stroke="#06B6D4" stroke-width="2.5"/><line x1="12" y1="20" x2="14" y2="18" stroke="#F59E0B" stroke-width="2.5"/><circle cx="12" cy="20" r="1.5" fill="#64748B"/><circle cx="14" cy="18" r="1" fill="#F59E0B"/></svg>
      </div>
      <div class="lab-card-body">
        <h3>Automotive Piston</h3>
        <p>Slider-crank mechanism: piston height, cylinder volume, TDC/BDC</p>
        <div class="card-badges"><span class="card-badge badge-drag">Drag</span><span class="card-badge badge-new">New</span></div>
      </div>
    </a>
...
<%--    </a>--%>
    ...
    <a href="tcoil-circuit.jsp" class="lab-card">
      <div class="lab-card-icon" style="background:linear-gradient(135deg,#06B6D4,#F59E0B);">
        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><line x1="2" y1="6" x2="6" y2="6"/><polyline points="6,6 7,4 8,6 9,4 10,6" stroke="#06B6D4"/><line x1="10" y1="6" x2="14" y2="6"/><polyline points="14,6 15,4 16,6 17,4 18,6" stroke="#06B6D4"/><line x1="18" y1="6" x2="22" y2="6"/><line x1="10" y1="3" x2="14" y2="3" stroke="#8B5CF6"/><line x1="10" y1="6" x2="10" y2="3"/><line x1="14" y1="6" x2="14" y2="3"/><line x1="12" y1="6" x2="12" y2="10"/><line x1="10.5" y1="10" x2="13.5" y2="10" stroke="#8B5CF6"/><line x1="10.5" y1="11" x2="13.5" y2="11" stroke="#8B5CF6"/><line x1="12" y1="11" x2="12" y2="13"/><path d="M3 14 Q6 20 12 18 Q18 16 21 14" fill="none" stroke="#F59E0B" stroke-width="1.5"/></svg>
      </div>
      <div class="lab-card-body">
        <h3>T-Coil Circuit</h3>
        <p>Transfer function, Bode plot, step response of bridged T-coil</p>
        <div class="card-badges"><span class="card-badge badge-new">New</span></div>
      </div>
    </a>
