...
<div class="labs-cat">
  ...
  <div class="labs-grid">
    ...
    <a href="quadrotor.jsp" class="lab-card">
      <div class="lab-card-icon" style="background:linear-gradient(135deg,#8B5CF6,#22C55E);">
        <svg viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"><line x1="4" y1="12" x2="20" y2="12" stroke-width="2.5"/><line x1="12" y1="4" x2="12" y2="20" stroke-width="1.5"/><circle cx="4" cy="12" r="2.5" fill="none" stroke="#F59E0B"/><circle cx="20" cy="12" r="2.5" fill="none" stroke="#F59E0B"/><circle cx="12" cy="4" r="2" fill="none" stroke="#F59E0B"/><circle cx="12" cy="20" r="2" fill="none" stroke="#F59E0B"/><circle cx="12" cy="12" r="1.5" fill="#8B5CF6" stroke="none"/><line x1="4" y1="12" x2="4" y2="8" stroke="#22C55E" stroke-width="1.5"/><line x1="20" y1="12" x2="20" y2="8" stroke="#22C55E" stroke-width="1.5"/></svg>
      </div>
      <div class="lab-card-body">
        <h3>Quadrotor Dynamics</h3>
        <p>12-state 6-DOF model with PD hover control, thrust vectors, Euler angles</p>
        <div class="card-badges"><span class="card-badge badge-drag">Drag</span><span class="card-badge badge-new">New</span></div>
      </div>
    </a>
