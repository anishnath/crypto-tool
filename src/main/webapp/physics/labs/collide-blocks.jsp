...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Colliding Blocks — Elastic and Inelastic Collisions" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Two blocks on a track with elastic and inelastic collisions. See momentum conservation, velocity swapping, and energy loss with coefficient of restitution. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/collide-blocks.jsp" />
    <jsp:param name="toolKeywords" value="colliding blocks, elastic collision, inelastic collision, momentum conservation, coefficient of restitution, Newton cradle, physics simulation" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="High School, Undergraduate" />
    <jsp:param name="teaches" value="Elastic collisions, inelastic collisions, momentum conservation, coefficient of restitution, impulse" />
    <jsp:param name="hasSteps" value="true" />
    <jsp:param name="howToSteps" value="Watch the collision|Block 2 approaches and hits block 1. Watch velocities swap,Set elasticity|Drag the elasticity slider from 1.0 elastic to 0.0 perfectly inelastic,Check momentum|Read the momentum display at the top of the canvas. Total momentum stays constant,View energy|Switch to the Energy tab to see how KE changes through collisions" />
    <jsp:param name="faq1q" value="What happens in a perfectly elastic collision between equal masses?" />
    <jsp:param name="faq1a" value="Block 2 stops completely and transfers all its velocity to block 1. This is the same physics behind Newton cradle. Set the Equal Mass preset and elasticity 1.0 to see this." />
    <jsp:param name="faq2q" value="Is momentum always conserved in collisions?" />
    <jsp:param name="faq2a" value="Yes. Total momentum p1 plus p2 is conserved in every collision whether elastic or inelastic. Only kinetic energy changes with elasticity. Set elasticity to zero and watch KE drop while the momentum readout stays constant." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  ...
  <nav class="lab-crumb">
    ...
    <span>Colliding Blocks</span>
  </nav>

  <h1 class="lab-title">Colliding Blocks</h1>
...
import { CollideBlocksSim } from './js/sims/collide-blocks.js';

const lab = createLab(CollideBlocksSim, {
...
document.getElementById('labInfo').innerHTML = CollideBlocksSim.info || '';
</script>
