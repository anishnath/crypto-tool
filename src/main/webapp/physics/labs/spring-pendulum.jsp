...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Spring Pendulum — Coupled 2D Oscillations & 2:1 Resonance" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="A mass on a spring swings like a pendulum AND bounces. Watch energy transfer between radial and angular modes. Discover 2:1 parametric resonance. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/spring-pendulum.jsp" />
    <jsp:param name="toolKeywords" value="spring pendulum, elastic pendulum, coupled oscillations, 2:1 resonance, parametric resonance, energy transfer, spring mass swing, AP physics, Lagrangian mechanics" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="High School, Undergraduate, AP Physics, Classical Mechanics" />
    <jsp:param name="teaches" value="elastic pendulum, coupled oscillations, parametric resonance, Coriolis effect, energy transfer between modes, polar coordinates" />
    <jsp:param name="faq1q" value="What is a spring pendulum and why does it show energy transfer?" />
    <jsp:param name="faq1a" value="A spring pendulum is a mass hanging from a spring that can both swing side to side like a pendulum and bounce up and down like a spring. The two modes are coupled through the equations of motion. When the spring frequency is about twice the pendulum frequency energy flows dramatically between the two modes in a phenomenon called parametric resonance." />
    <jsp:param name="faq2q" value="What is the 2 to 1 resonance condition for a spring pendulum?" />
    <jsp:param name="faq2a" value="The 2 to 1 resonance occurs when the spring oscillation period is half the pendulum period. This means omega spring equals 2 times omega pendulum or equivalently k equals 3mg divided by L0. At this ratio energy transfers most efficiently between radial bouncing and angular swinging." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  <nav class="lab-crumb">
    ...
    <span>Spring Pendulum</span>
  </nav>
  <h1 class="lab-title">Spring Pendulum (Elastic Pendulum)</h1>
  <div id="labTabs"></div>
  <div class="lab-grid">
  ...
  <div class="lab-related">
    ...
    <a href="<%=request.getContextPath()%>/physics/labs/vertical-spring.jsp">Vertical Spring</a>
...
import { SpringPendulumSim } from './js/sims/spring-pendulum.js';
const lab = createLab(SpringPendulumSim, {
...
document.getElementById('labInfo').innerHTML = SpringPendulumSim.info || '';
</script>
<script>
(function(){
