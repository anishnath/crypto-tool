...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Series vs Parallel Springs — Side-by-Side Comparison Simulator" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Compare series and parallel spring configurations side by side. See how k_eff changes: series = k1k2/(k1+k2), parallel = k1+k2. Watch both oscillate simultaneously. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/series-parallel-springs.jsp" />
    <jsp:param name="toolKeywords" value="series springs, parallel springs, effective spring constant, k_eff, spring combination, Hooke's law, SHM comparison, AP physics springs" />
    ...
    <jsp:param name="teaches" value="series springs, parallel springs, effective spring constant, harmonic mean, spring stiffness, oscillation period comparison" />
    <jsp:param name="faq1q" value="What is the effective spring constant of two springs in series?" />
    <jsp:param name="faq1a" value="For two springs in series the effective spring constant is k_eff = k1 times k2 divided by k1 plus k2. This is always less than either individual spring constant because the combination is softer." />
    <jsp:param name="faq2q" value="What is the effective spring constant of two springs in parallel?" />
    <jsp:param name="faq2a" value="For two springs in parallel the effective spring constant is k_eff = k1 plus k2. This is always greater than either spring alone because both springs share the load." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  <nav class="lab-crumb">
    ...
    <span>Series vs Parallel Springs</span>
  </nav>
  <h1 class="lab-title">Series vs Parallel Springs</h1>
  <div id="labTabs"></div>
  <div class="lab-grid">
...
import { SeriesParallelSim } from './js/sims/series-parallel-springs.js';
const lab = createLab(SeriesParallelSim, {
...
document.getElementById('labInfo').innerHTML = SeriesParallelSim.info || '';
</script>
<script>
(function(){
