...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Molecule Simulator — N-Body Spring Dynamics" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Interactive 2D molecular dynamics simulation. 2 to 6 atoms connected by springs with gravity and wall collisions. Drag atoms, change atom count, explore vibrational modes. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/molecule.jsp" />
    <jsp:param name="toolKeywords" value="molecular dynamics simulator, N-body simulation, spring network, atom simulation, vibrational modes, 2D physics, molecule simulator" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="High School, Undergraduate" />
    <jsp:param name="teaches" value="Molecular dynamics, N-body interactions, Hooke's law in 2D, vibrational modes, energy conservation, elastic collisions" />
    <jsp:param name="hasSteps" value="true" />
    <jsp:param name="howToSteps" value="Drag an atom|Click and drag any colored atom to stretch springs then release,Change atom count|Use the Atoms slider to go from 2 to 6 atoms with full spring connectivity,Adjust physics|Change stiffness and gravity and damping to see different behaviors,Watch wall bounces|Atoms bounce off the box walls with configurable elasticity" />
    <jsp:param name="faq1q" value="How are the atoms connected?" />
    <jsp:param name="faq1a" value="Every atom is connected to every other atom by a spring. With N atoms there are N times N minus 1 divided by 2 springs. So 3 atoms have 3 springs forming a triangle and 6 atoms have 15 springs forming a complex network." />
    <jsp:param name="faq2q" value="What are vibrational modes?" />
    <jsp:param name="faq2a" value="With zero gravity and damping the molecule has distinct vibration patterns called normal modes. These include breathing modes where all atoms expand and contract together and rocking modes where the molecule tilts. These are the same modes measured by infrared spectroscopy in real molecules." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  ...
  <h1 class="lab-title">Molecule Dynamics</h1>
...
import { MoleculeSim } from './js/sims/molecule.js';

const lab = createLab(MoleculeSim, {
