...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Automotive Piston Simulator — Slider-Crank Mechanism" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Simulate an automotive piston connected to a crankshaft via a connecting rod. Visualize piston height, cylinder volume, TDC, BDC, and stroke. Adjust crank radius, rod length, bore, and RPM. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/piston.jsp" />
    <jsp:param name="toolKeywords" value="piston simulator, slider crank mechanism, connecting rod, crankshaft, TDC, BDC, stroke length, bore diameter, cylinder volume, engine simulation, automotive engineering, mechanical engineering" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="High School, Undergraduate, AP Physics, Mechanical Engineering" />
    <jsp:param name="teaches" value="slider-crank mechanism, piston kinematics, connecting rod geometry, top dead center, bottom dead center, swept volume, crank angle, reciprocating motion" />
    <jsp:param name="faq1q" value="How does a slider crank mechanism convert rotary motion to linear motion?" />
    <jsp:param name="faq1a" value="A slider crank mechanism uses a rotating crank arm connected to a sliding piston through a connecting rod. As the crankshaft rotates the crank pin traces a circle. The connecting rod constrains the piston to move only vertically. The piston height is H equals a times cosine theta plus the square root of L squared minus a squared times sine squared theta where a is the crank radius L is the connecting rod length and theta is the crank angle." />
    <jsp:param name="faq2q" value="What are TDC and BDC in an engine and how do they relate to cylinder volume?" />
    <jsp:param name="faq2a" value="TDC or top dead center is when the piston is at its highest point at crank angle zero. The piston height at TDC equals L plus a. BDC or bottom dead center is when the piston is at its lowest point at crank angle 180 degrees. The piston height at BDC equals L minus a. The stroke length is 2a. Cylinder volume is minimum at TDC and maximum at BDC. The swept volume or displacement equals pi times B over 2 squared times 2a." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  <nav class="lab-crumb">
    ...
    <span>Automotive Piston</span>
  </nav>
  <h1 class="lab-title">Automotive Piston (Slider-Crank Mechanism)</h1>
  <div id="labTabs"></div>
  <div class="lab-grid">
...
import { PistonSim } from './js/sims/piston.js';
const lab = createLab(PistonSim, {
...
document.getElementById('labInfo').innerHTML = PistonSim.info || '';
</script>
<script>
(function(){
