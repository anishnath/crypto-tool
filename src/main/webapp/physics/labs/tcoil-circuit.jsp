...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="T-Coil Circuit Simulator — Bode Plot & Transfer Function" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Analyze the transfer function of a bridged T-coil bandwidth extension circuit. Interactive Bode plot, step response, and circuit diagram. Adjust inductors, capacitors, coupling, and resistances. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/tcoil-circuit.jsp" />
    <jsp:param name="toolKeywords" value="T-coil circuit, bridged T-coil, bandwidth extension, transfer function, Bode plot, step response, mutual inductance, inductive peaking, signal integrity, high speed design" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="Undergraduate, Graduate, Electrical Engineering, Signal Integrity" />
    <jsp:param name="teaches" value="T-coil bandwidth extension, transfer function analysis, Bode plot, frequency response, step response, mutual inductance, bridged T-coil topology, parasitic resistance effects" />
    <jsp:param name="faq1q" value="What is a T-coil circuit and how does it extend bandwidth?" />
    <jsp:param name="faq1a" value="A T-coil or bridged T-coil is a circuit with two mutually coupled inductors and a bridge capacitor that extends signal bandwidth beyond simple inductive peaking. At low frequencies the signal passes through the inductors while at high frequencies it bypasses them through the bridge capacitor. This provides two complementary signal paths that maintain nearly flat frequency response over a wider bandwidth." />
    <jsp:param name="faq2q" value="How do parasitic resistances affect the T-coil transfer function?" />
    <jsp:param name="faq2a" value="Parasitic resistances Ra and Rb in the inductor windings reduce the DC gain because they add to the voltage divider between R1 and R2. The DC gain drops from R2 over R1 plus R2 to R2 over R1 plus Ra plus Rb plus R2. They also slightly reduce the bandwidth and shift the frequency of minimum attenuation. Toggle the Compare No Parasitics option to see the difference." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  <nav class="lab-crumb">
    ...
    <span>T-Coil Circuit</span>
  </nav>
  <h1 class="lab-title">T-Coil Circuit (Bridged T-Coil Transfer Function)</h1>
  <div id="labTabs"></div>
  <div class="lab-grid">
...
import { TCoilSim } from './js/sims/tcoil-circuit.js';
const lab = createLab(TCoilSim, {
...
document.getElementById('labInfo').innerHTML = TCoilSim.info || '';
</script>
<script>
(function(){
