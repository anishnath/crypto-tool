...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Brachistochrone — Curve of Fastest Descent Race" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Four balls race from A to B on different curves. The cycloid always wins. The famous brachistochrone problem visualized as a real-time race. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/brachistochrone.jsp" />
    <jsp:param name="toolKeywords" value="brachistochrone, curve of fastest descent, cycloid, calculus of variations, optimal path, roller coaster physics, Johann Bernoulli" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="High School, Undergraduate" />
    <jsp:param name="teaches" value="Brachistochrone problem, calculus of variations, cycloid curve, optimal trajectories, constrained motion" />
    <jsp:param name="hasSteps" value="true" />
    <jsp:param name="howToSteps" value="Watch the race|Four balls start simultaneously on different curves. The cycloid always arrives first,Compare curves|Watch the straight line lose to the longer cycloid path,Change gravity|Try Moon gravity to see the same race in slow motion,View time graph|Switch to Time tab to see each ball position over time" />
    <jsp:param name="faq1q" value="What is the brachistochrone?" />
    <jsp:param name="faq1a" value="It is the curve of fastest descent between two points under gravity. Johann Bernoulli posed this problem in 1696 and the solution is a cycloid. This simulator shows four balls racing on different curves to prove the cycloid always wins." />
    <jsp:param name="faq2q" value="Why does the cycloid win even though it is longer?" />
    <jsp:param name="faq2a" value="The cycloid dips steeply at the start converting potential energy to speed early. The ball reaches high velocity quickly then traverses the longer path faster than a ball on the shorter straight line that accelerates slowly." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  ...
  <h1 class="lab-title">Brachistochrone</h1>
...
import { BrachistochroneSim } from './js/sims/brachistochrone.js';

const lab = createLab(BrachistochroneSim, {
...
document.getElementById('labInfo').innerHTML = BrachistochroneSim.info || '';
</script>
