...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Bungee Jump Simulator — Free Fall + Spring Physics" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Simulate a bungee jump: free fall, cord engages, bouncing. See three phases of motion, energy conversion, and whether the jumper survives. Adjust mass, cord length, stiffness. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/bungee.jsp" />
    <jsp:param name="toolKeywords" value="bungee jump physics, bungee cord simulation, free fall spring, piecewise motion, energy conservation bungee, elastic potential energy, SHM bungee, AP physics" />
    ...
    <jsp:param name="teaches" value="free fall, bungee cord physics, piecewise equations of motion, energy conservation, elastic potential energy, spring force, SHM" />
    <jsp:param name="faq1q" value="What are the phases of a bungee jump?" />
    <jsp:param name="faq1a" value="A bungee jump has three phases. Phase 1 is free fall where the cord is slack and acceleration equals g. Phase 2 is bungee engaged where the stretched cord pulls back with force k times stretch. Phase 3 is the bounce where the jumper may rise above the cord natural length causing it to go slack again." />
    <jsp:param name="faq2q" value="How do you calculate the lowest point of a bungee jump?" />
    <jsp:param name="faq2a" value="Use energy conservation. The gravitational PE lost equals the elastic PE gained: mg times L0 plus x_max equals one half k times x_max squared. Solve the quadratic for x_max then subtract from the platform height." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  ...
  <h1 class="lab-title">Bungee Jump Simulator</h1>
  <div id="labTabs"></div>
  <div class="lab-grid">
...
import { BungeeSim } from './js/sims/bungee.js';
const lab = createLab(BungeeSim, {
...
document.getElementById('labInfo').innerHTML = BungeeSim.info || '';
</script>
<script>
(function(){
