...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="AC Generator Simulator — Faraday's Law & Electromagnetic Induction" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Simulate an AC generator with a rotating coil in a magnetic field. Visualize Faraday's law, magnetic flux, induced EMF, current waveform, and DC commutator mode. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/generator.jsp" />
    <jsp:param name="toolKeywords" value="AC generator, electromagnetic induction, Faraday's law, magnetic flux, EMF, rotating coil, commutator, DC generator, alternating current, AP physics" />
    ...
    <jsp:param name="teaches" value="Faraday's law, electromagnetic induction, magnetic flux, AC voltage, peak EMF, commutator, slip rings, phase relationship between flux and EMF" />
    <jsp:param name="faq1q" value="How does an AC generator produce electricity?" />
    <jsp:param name="faq1a" value="An AC generator works by rotating a coil of wire in a magnetic field. As the coil rotates the magnetic flux through it changes sinusoidally. By Faraday's law the changing flux induces an EMF equal to negative d phi d t which equals N B A omega sin theta. The EMF alternates direction each half revolution producing alternating current." />
    <jsp:param name="faq2q" value="What is the difference between AC and DC generators?" />
    <jsp:param name="faq2a" value="Both AC and DC generators use a rotating coil in a magnetic field to produce electricity. The difference is in how the output is collected. An AC generator uses slip rings that maintain continuous contact giving a sinusoidal output. A DC generator uses a split ring commutator that reverses the connection every half turn so the output is always in the same direction giving pulsating DC." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  <nav class="lab-crumb">
    ...
    <span>AC Generator</span>
  </nav>
  <h1 class="lab-title">AC Generator (Electromagnetic Induction)</h1>
  <div id="labTabs"></div>
  <div class="lab-grid">
...
import { GeneratorSim } from './js/sims/generator.js';
const lab = createLab(GeneratorSim, {
...
document.getElementById('labInfo').innerHTML = GeneratorSim.info || '';
</script>
<script>
(function(){
