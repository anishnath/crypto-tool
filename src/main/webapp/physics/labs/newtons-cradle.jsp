...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Newton's Cradle — Momentum Chain Simulator" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="The classic desktop toy simulated with real physics. Lift 1, 2, or 3 balls and watch momentum transfer through the chain. Adjustable damping and elasticity. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/newtons-cradle.jsp" />
    <jsp:param name="toolKeywords" value="Newton's cradle, momentum transfer, elastic collision chain, conservation laws, desktop toy physics" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="High School, Undergraduate" />
    <jsp:param name="teaches" value="Newton's cradle physics, momentum conservation, kinetic energy conservation, elastic collision chain" />
    <jsp:param name="hasSteps" value="true" />
    <jsp:param name="howToSteps" value="Lift and release|One ball swings down and the opposite end ball swings out,Try 2 balls|Lift 2 balls and watch 2 swing out the other side,Add damping|Real cradles slow down due to air resistance and internal friction,Lower elasticity|Watch the crisp swings decay into all balls moving together" />
    <jsp:param name="faq1q" value="Why does only one ball swing out when one ball hits?" />
    <jsp:param name="faq1a" value="This is the only solution that conserves BOTH momentum and kinetic energy simultaneously. Two balls at half speed would conserve momentum but only half the kinetic energy. The elastic constraint forces exactly N balls to leave at the same speed." />
    <jsp:param name="faq2q" value="What happens with damping in a real cradle?" />
    <jsp:param name="faq2a" value="Real cradles gradually lose energy to air resistance and sound. The swings get smaller until all balls hang still. Set damping to 0.05 to see this realistic decay. Lower elasticity to 0.85 to see the swings merge into all balls moving together." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  ...
  <h1 class="lab-title">Newton's Cradle</h1>
  ...
  <div class="lab-related">
    ...
    <a href="<%=request.getContextPath()%>/physics/labs/billiards.jsp">Billiards</a>
...
import { NewtonsCradleSim } from './js/sims/newtons-cradle.js';

const lab = createLab(NewtonsCradleSim, {
...
document.getElementById('labInfo').innerHTML = NewtonsCradleSim.info || '';
</script>
