...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Pile Simulator — Rigid Body Stacking" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Drop polygon shapes and watch them stack tumble and collide. SAT collision detection with friction and restitution. Drag and throw bodies. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/pile.jsp" />
    <jsp:param name="toolKeywords" value="rigid body simulator, SAT collision, polygon stacking, pile physics, friction, restitution, game physics" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="High School, Undergraduate" />
    <jsp:param name="teaches" value="Rigid body dynamics, SAT collision detection, polygon physics, stacking, friction, rotational dynamics" />
    <jsp:param name="hasSteps" value="true" />
    <jsp:param name="howToSteps" value="Drop shapes|Bodies fall under gravity and stack on the floor,Drag and throw|Click any body to grab it and fling it into the pile,Change shapes|Select boxes or triangles or pentagons or mixed shapes,Adjust bounce|Increase bounciness for elastic collisions or decrease for sticky piles" />
    <jsp:param name="faq1q" value="How does SAT collision detection work?" />
    <jsp:param name="faq1a" value="The Separating Axis Theorem tests all edge normals of both polygons. If any axis separates them there is no collision. The axis with minimum overlap gives the collision normal and penetration depth. This is the same algorithm used in game engines like Box2D and Unity." />
    <jsp:param name="faq2q" value="What determines if bodies stack or scatter?" />
    <jsp:param name="faq2a" value="Restitution controls energy loss on impact. Low restitution absorbs impact energy so bodies settle quickly. High friction prevents sliding so stacks are stable. Together they determine whether a pile stays put or collapses. Try the Bouncy vs Sticky presets to compare." />
</jsp:include>
...
import { PileSim } from './js/sims/pile.js';

const lab = createLab(PileSim, {
...
document.getElementById('labInfo').innerHTML = PileSim.info || '';
</script>
