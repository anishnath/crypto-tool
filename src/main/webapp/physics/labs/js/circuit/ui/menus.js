...
const CIRCUITS_MENU = [
  ...
  { label: 'Transistors', sub: [
    ...
    { label: 'Darlington Pair', action: 'preset:darlington' },
  ...
  { label: 'Logic Gates', sub: [
    ...
    { label: 'Half Adder', action: 'preset:half-adder' },
  ...
  { label: 'Signal Generators', sub: [
    { label: 'Schmitt Trigger', action: 'preset:schmitt-trigger' },
...
const DRAW_MENU = [
  ...
  { label: 'Inputs and Sources', sub: [
    ...
    { label: 'VCVS (Dependent Voltage)', type: 'vcvs' },
    { label: 'VCCS (Dependent Current)', type: 'vccs' },
  ]},
  ...
  { label: 'Active Components', sub: [
    ...
    { label: 'SCR/Thyristor (Ideal Switch)', type: 'ideal-switch' },
  ]},
