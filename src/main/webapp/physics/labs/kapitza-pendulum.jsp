...
<jsp:include page="../../modern/components/seo-tool-page.jsp">
    <jsp:param name="toolName" value="Kapitza Pendulum — Inverted Pendulum Stabilized by Vibration" />
    <jsp:param name="toolCategory" value="Physics" />
    <jsp:param name="toolDescription" value="Interactive Kapitza pendulum simulation. Watch an inverted pendulum stabilize through rapid pivot vibration. Explore parametric resonance and the stability threshold. Free no signup. Free, no signup." />
    <jsp:param name="toolUrl" value="physics/labs/kapitza-pendulum.jsp" />
    <jsp:param name="toolKeywords" value="Kapitza pendulum, inverted pendulum, vibrating pivot, parametric stabilization, Kapitza effect, pendulum physics, vibration stabilization" />
    <jsp:param name="toolImage" value="logo.png" />
    <jsp:param name="breadcrumbCategoryUrl" value="physics/" />
    <jsp:param name="educationalLevel" value="Undergraduate, Graduate" />
    <jsp:param name="teaches" value="Kapitza effect, parametric stabilization, inverted pendulum, vibrating pivot, effective potential" />
    <jsp:param name="faq1q" value="What is the Kapitza effect?" />
    <jsp:param name="faq1a" value="The Kapitza effect is the stabilization of an inverted pendulum through rapid vertical vibration of its pivot point. When the vibration frequency and amplitude are high enough the normally unstable upside-down position becomes a stable equilibrium. The pendulum actually balances inverted." />
    <jsp:param name="faq2q" value="Why does vibration stabilize the inverted position?" />
    <jsp:param name="faq2a" value="Rapid vibration modifies the time-averaged effective potential. The oscillating acceleration adds a restoring force at the inverted position creating an effective potential well where there was previously a hilltop. The stability condition requires the vibration acceleration to exceed about twice gravitational pull." />
</jsp:include>
...
<div class="ad-lab-hero" id="ad_lab_hero"><div class="ad-label">Advertisement</div></div>
  ...
  <nav class="lab-crumb">
    ...
    <span>Kapitza Pendulum</span>
  </nav>

  <h1 class="lab-title">Kapitza Pendulum</h1>
  ...
  <div class="lab-related">
    ...
    <a href="<%=request.getContextPath()%>/physics/labs/compare-pendulum.jsp">Butterfly Effect</a>
...
import { KapitzaPendulumSim } from './js/sims/kapitza-pendulum.js';

const lab = createLab(KapitzaPendulumSim, {
