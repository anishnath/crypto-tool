...
<html lang="en">
	<head>
		...
		<meta content='text/html; charset=UTF-8' http-equiv='Content-Type'>
		 ...
		 <meta name="keywords" content="file encryption, web-based encryption, file decryption, web-based decryption">
    	<meta name="description" content="A web application for file encryption and decryption using your web browser. Encrypt and decrypt files with ease.">
    	
    	   <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebApplication",
            "name": "Web Encryption Tool",
            "description": "A web application for file encryption and decryption using a web browser.",
    ...
    <div class="row">
        <div class="col-md-6 text-left">
            <h1>
                <button id="btnRefresh" class="btn btn-secondary btn-sm" onClick="javascript:location.reload();">Refresh Page</button>
                <button id="btnDivEncrypt" class="btn btn-primary btn-sm" onClick="javascript:switchdiv('encrypt');">Encrypt a File</button>
                <button id="btnDivDecrypt" class="btn btn-primary btn-sm" onClick="javascript:switchdiv('decrypt');">Decrypt a File</button>
            </h1>
        </div>
    </div>
</div>
    ...
    <div class="table-responsive">
        <table class="table">
            <tbody>
                <tr>
                    <td>Password</td>
                    <td><input id="txtEncpassphrase" type="password" class="form-control" size="30" onkeyup="javascript:encvalidate();" value=""></td>
                    <td>(minimum length eight characters, make sure it's strong!)</td>
                </tr>
                <tr>
                    <td>Password (retype)</td>
                    <td><input id="txtEncpassphraseretype" type="password" class="form-control" size="30" onkeyup="javascript:encvalidate();" value=""></td>
                    <td><span class="greenspan" id="spnCheckretype"></span></td>
                </tr>
            </tbody>
        </table>
    </div>
	...
	<div>
        <div class="dropzone" id="encdropzone" ondrop="drop_handler(event);" ondragover="dragover_handler(event);" ondragend="dragend_handler(event);">
            <p>Drag and drop the file to be encrypted or click <a onclick="javascript:encfileElem.click();">here</a> to select a file.</p>
    ...
    <div class="table-responsive">
        <table class="table">
            <tbody>
                <tr>
                    <td><button id="btnEncrypt" onclick="javascript:encryptfile();" class="btn btn-primary" disabled>Encrypt File</button></td>
                    <td><span id="spnEncstatus"></span></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="table-responsive">
        <table class="table">
            <tbody>
                <tr>
                    <td>Password</td>
                    <td><input id="txtDecpassphrase" type="password" class="form-control" size="20" onkeyup="javascript:decvalidate();" value=''></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="table-responsive">
        <table class="table">
            <tbody>
                <tr>
                    <td><button id="btnDecrypt" onclick="javascript:decryptfile();" class="btn btn-primary" disabled>Decrypt File</button></td>
                    <td><span id="spnDecstatus"></span></td>
                </tr>
            </tbody>
        </table>
    </div>
