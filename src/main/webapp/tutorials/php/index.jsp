<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%-- PHP Tutorial - Landing Page --%>
        ...
        <head>
            ...
            <title>PHP Tutorial - Learn PHP Programming | 8gwifi.org Tutorials</title>
            <meta name="description"
                content="Learn PHP programming from scratch with interactive examples. Free PHP tutorial for beginners to advanced with live code editor, database integration, and security.">
            ...
            <script type="application/ld+json">
    {
        ...
        "@type": "Course",
        "name": "PHP Programming Tutorial",
        "description": "A comprehensive interactive course to learn PHP programming from scratch to advanced topics including databases and security.",
        "provider": {
            "@type": "Organization",
            "name": "8gwifi.org",
                        ...
                        <%@ include file="../tutorial-sidebar-php.jsp" %>
                            ...
                            <article class="tutorial-content" style="margin-right: 0;">
                                ...
                                <header class="lesson-header">
                                    <h1 class="lesson-title">PHP Tutorial</h1>
                                    <p
                                        style="font-size: var(--text-lg); color: var(--text-secondary); max-width: 600px;">
                                        Learn PHP programming from scratch with interactive examples. Master server-side
                                        development, databases, security, and build dynamic web applications.
                                    </p>
                                </header>
                                ...
                                <div class="lesson-body">
                                    <div style="display: grid; gap: var(--space-4); margin-top: var(--space-8);">
                                        <%-- Start Learning Card --%>
                                            <a href="<%=request.getContextPath()%>/tutorials/php/intro.jsp" class="card"
                                            ...
                                            <%-- What You'll Learn --%>
                                                <div class="card">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>Web forms, sessions, and cookies</li>
                                                        <li>File operations and directory management</li>
                                                        <li>Database integration (MySQL, PDO)</li>
                                                        <li>Security best practices (XSS, CSRF, SQL injection)</li>
                                                        <li>Advanced: APIs, regex, error handling</li>
                                                        <li>Professional: Composer, testing, deployment</li>
                                                    </ul>
                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Introduction to PHP</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    <strong style="color: var(--text-primary);">2.
                                                                        Variables & Types</strong>
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Data types, strings, constants</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Indexed, associative, functions</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    ...
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Classes, inheritance, traits</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    <strong style="color: var(--text-primary);">8.
                                                                        Superglobals & Forms</strong>
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        GET, POST, sessions, cookies</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    <strong style="color: var(--text-primary);">9. File
                                                                        & Directory</strong>
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        File I/O, CSV, JSON</p>
