<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%-- CSS Tutorial - Landing Page --%>
        ...
        <head>
            ...
            <title>CSS Tutorial - Learn CSS from Scratch | 8gwifi.org Tutorials</title>
            <meta name="description"
                content="Learn CSS from scratch with interactive examples. Free CSS tutorial for beginners covering selectors, layouts, animations, and modern CSS features.">
                        ...
                        <%@ include file="../tutorial-sidebar-css.jsp" %>
                            ...
                            <article class="tutorial-content" style="margin-right: 0;">
                                ...
                                <header class="lesson-header">
                                    <h1 class="lesson-title">CSS Tutorial</h1>
                                    <p
                                        style="font-size: var(--text-lg); color: var(--text-secondary); max-width: 600px;">
                                        Master CSS from fundamentals to advanced techniques. Learn layouts, animations,
                                        and modern CSS features with interactive examples.
                                    </p>
                                </header>
                                ...
                                <div class="lesson-body">
                                    <div style="display: grid; gap: var(--space-4); margin-top: var(--space-8);">
                                        <%-- Start Learning Card --%>
                                            <a href="<%=request.getContextPath()%>/tutorials/css/introduction.jsp"
                                                class="card"
                                            ...
                                            <%-- What You'll Learn --%>
                                                <div class="card">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>Box model, layouts, and positioning</li>
                                                        <li>Flexbox and CSS Grid</li>
                                                        <li>Animations and transitions</li>
                                                        <li>Responsive design and media queries</li>
                                                        <li>Modern CSS features (Variables, Functions, Filters)</li>
                                                        <li>Best practices and performance</li>
                                                    </ul>
                                                </div>
