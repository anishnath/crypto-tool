        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>base64_decode()</code> function performs a specific operation.</p>

                    <h2>Syntax</h2>
                    <pre><code class="language-php">base64_decode($param): mixed</code></pre>
                    ...
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="codeFile" value="php-functions/base64_decode.php" />
                        <jsp:param name="language" value="php" />
                        <jsp:param name="editorId" value="base64_decode-demo" />
                    </jsp:include>
