        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>preg_match_all()</code> function performs a global regular expression match, finding all occurrences.</p>
                    <h2>Syntax</h2>
                    <pre><code class="language-php">preg_match_all(string $pattern, string $subject, array &$matches = null): int|false</code></pre>
                    <h2>Try It Online</h2>
                    <jsp:include page="../tutorial-compiler.jsp"><jsp:param name="codeFile" value="php-functions/preg_match_all.php" /><jsp:param name="language" value="php" /><jsp:param name="editorId" value="preg-match-all-demo" /></jsp:include>
                    <jsp:include page="../tutorial-ad-slot.jsp"><jsp:param name="slot" value="middle" /></jsp:include>
                    <h2>Examples</h2>
                    <pre><code class="language-php">&lt;?php
$text = "Call 123-456 or 789-012";
preg_match_all('/\d{3}-\d{3}/', $text, $matches);
print_r($matches[0]); // ['123-456', '789-012']
?&gt;</code></pre>
                    <h2>Related Functions</h2>
                    <ul><li><a href="preg_match.jsp">preg_match()</a> - Single match</li><li><a href="preg_replace.jsp">preg_replace()</a> - Search and replace</li></ul>
                </div>
                <jsp:include page="../tutorial-ad-slot.jsp"><jsp:param name="slot" value="bottom" /></jsp:include>
                <jsp:include page="../tutorial-nav.jsp"><jsp:param name="prevLink" value="preg_match.jsp" /><jsp:param name="prevTitle" value="preg_match()" /><jsp:param name="nextLink" value="preg_replace.jsp" /><jsp:param name="nextTitle" value="preg_replace()" /><jsp:param name="currentLessonId" value="preg_match_all" /></jsp:include>
            </article>
        </main>
