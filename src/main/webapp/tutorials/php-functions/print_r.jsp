...
<% request.setAttribute("currentFunction", "print_r"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PHP print_r() - Print Array Online | Example</title>
    <meta name="description" content="PHP print_r() prints human-readable information about variable. Arrays and objects. Debugging. Try online.">
    <meta name="keywords" content="php print_r, print_r php, php print array, print_r example, php debug array">
    <link rel="canonical" href="https://8gwifi.org/tutorials/php-functions/print_r.jsp">
    <meta property="og:title" content="PHP print_r() - Print Array"><meta property="og:type" content="article">
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"TechArticle","headline":"PHP print_r() Function","datePublished":"2025-01-01","dateModified":"2025-01-28"}</script>
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Tutorials","item":"https://8gwifi.org/tutorials/"},{"@type":"ListItem","position":2,"name":"PHP Functions","item":"https://8gwifi.org/tutorials/php-functions/"},{"@type":"ListItem","position":3,"name":"print_r()"}]}</script>
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>print_r()</code> function performs a specific operation.</p>

                    <h2>Syntax</h2>
                    <pre><code class="language-php">print_r($param): mixed</code></pre>
                    ...
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="codeFile" value="php-functions/print_r.php" />
                        <jsp:param name="language" value="php" />
                        <jsp:param name="editorId" value="print_r-demo" />
                    </jsp:include>
