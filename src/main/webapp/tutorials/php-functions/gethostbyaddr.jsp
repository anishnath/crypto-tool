        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>gethostbyaddr()</code> function performs a specific operation.</p>

                    <h2>Syntax</h2>
                    <pre><code class="language-php">gethostbyaddr($param): mixed</code></pre>
                    ...
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="codeFile" value="php-functions/gethostbyaddr.php" />
                        <jsp:param name="language" value="php" />
                        <jsp:param name="editorId" value="gethostbyaddr-demo" />
                    </jsp:include>
