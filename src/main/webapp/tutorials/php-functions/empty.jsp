        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>empty()</code> function performs a specific operation.</p>

                    <h2>Syntax</h2>
                    <pre><code class="language-php">empty($param): mixed</code></pre>
                    ...
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="codeFile" value="php-functions/empty.php" />
                        <jsp:param name="language" value="php" />
                        <jsp:param name="editorId" value="empty-demo" />
                    </jsp:include>
