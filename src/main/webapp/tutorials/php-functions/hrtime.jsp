<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% request.setAttribute("currentFunction", "hrtime" ); %>
        <!DOCTYPE html>
        <html lang="en">
    ...
    <meta name="twitter:description" content="PHP hrtime() returns high resolution time for precise measurements. Interactive examples with live code. Syntax: hrtime($as_number). Nanosecond precision. Try it free!">
            ...
            <script
                type="application/ld+json">{"@context":"https://schema.org","@type":"TechArticle","headline":"PHP hrtime() Function","datePublished":"2025-01-28","dateModified":"2025-01-28"}</script>
            <script
                type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Tutorials","item":"https://8gwifi.org/tutorials/"},{"@type":"ListItem","position":2,"name":"PHP Functions","item":"https://8gwifi.org/tutorials/php-functions/"},{"@type":"ListItem","position":3,"name":"hrtime()"}]}</script>
            <%@ include file="../tutorial-ads.jsp" %>
                <%@ include file="../tutorial-analytics.jsp" %>
        </head>

        <body class="tutorial-body no-preview" data-lesson="hrtime">
                        ...
                        <%@ include file="../tutorial-sidebar-php-functions.jsp" %>
                            ...
                            <article class="tutorial-content">
                                <nav class="breadcrumb"><a
                                        ...
                                        Functions</a><span class="breadcrumb-separator">/</span><span>hrtime()</span>
                                </nav>
                                <header class="lesson-header">
                                    <h1 class="lesson-title">PHP hrtime() Function</h1>
                                    <div class="lesson-meta"><span>Date/Time Function</span><span>PHP 7.3+</span></div>
                                </header>
                                <div class="lesson-body">
                                    <p class="lead">The <code>hrtime()</code> function returns the system's high
                                        resolution time. It is monotonic (cannot go backwards) and is best for precise
                                        performance measurements.</p>
                                    <h2>Syntax</h2>
                                    <pre><code class="language-php">hrtime(bool $as_number = false): array|int|float</code></pre>
                                    <h2>Return Value</h2>
                                    <p>Returns an array [seconds, nanoseconds] if <code>as_number</code> is false.
                                        Returns nanoseconds as int (64-bit platforms) or float (32-bit platforms) if
                                        <code>as_number</code> is true.</p>
                                    <h2>Try It Online</h2>
                                    <jsp:include page="../tutorial-compiler.jsp">
                                        <jsp:param name="codeFile" value="php-functions/hrtime.php" />
                                        <jsp:param name="language" value="php" />
                                        <jsp:param name="editorId" value="hrtime-demo" />
                                    </jsp:include>
                                ...
                                <jsp:include page="../tutorial-nav.jsp">
                                    ...
                                    <jsp:param name="nextLink" value="idate.jsp" />
                                    <jsp:param name="nextTitle" value="idate()" />
                                    <jsp:param name="currentLessonId" value="hrtime" />
                                </jsp:include>
                            </article>
