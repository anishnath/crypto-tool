        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>http_build_query()</code> function performs a specific operation.</p>

                    <h2>Syntax</h2>
                    <pre><code class="language-php">http_build_query($param): mixed</code></pre>
                    ...
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="codeFile" value="php-functions/http_build_query.php" />
                        <jsp:param name="language" value="php" />
                        <jsp:param name="editorId" value="http_build_query-demo" />
                    </jsp:include>
