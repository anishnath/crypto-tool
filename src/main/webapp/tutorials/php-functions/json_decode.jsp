...
<% request.setAttribute("currentFunction", "json_decode"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PHP json_decode() - Parse JSON Online | Example</title>
    <meta name="description" content="PHP json_decode() decodes JSON string to PHP object or array. Syntax: json_decode($json, true). API parsing. Try online.">
    <meta name="keywords" content="php json_decode, json_decode php, php parse json, json to array php, json_decode example">
    <link rel="canonical" href="https://8gwifi.org/tutorials/php-functions/json_decode.jsp">
    <meta property="og:title" content="PHP json_decode() - Parse JSON"><meta property="og:type" content="article">
    ...
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"TechArticle","headline":"PHP json_decode() Function","datePublished":"2025-01-01","dateModified":"2025-01-28"}</script>
    <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How to convert JSON to array in PHP?","acceptedAnswer":{"@type":"Answer","text":"Use json_decode($json, true). The second parameter true returns associative array instead of object."}}]}</script>
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>json_decode()</code> function performs a specific operation.</p>

                    <h2>Syntax</h2>
                    <pre><code class="language-php">json_decode($param): mixed</code></pre>
                    ...
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="codeFile" value="php-functions/json_decode.php" />
                        <jsp:param name="language" value="php" />
                        <jsp:param name="editorId" value="json_decode-demo" />
                    </jsp:include>
