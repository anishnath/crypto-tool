        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>password_get_info()</code> function returns information about the given hash.</p>
                    <h2>Syntax</h2>
                    <pre><code class="language-php">password_get_info(string $hash): array</code></pre>
                    <h2>Return Value</h2>
                    <p>Returns array with <code>algo</code>, <code>algoName</code>, and <code>options</code> keys.</p>
                    <h2>Try It Online</h2>
                    <jsp:include page="../tutorial-compiler.jsp"><jsp:param name="codeFile" value="php-functions/password_get_info.php" /><jsp:param name="language" value="php" /><jsp:param name="editorId" value="password-get-info-demo" /></jsp:include>
...
?&gt;</code></pre>
                ...
                <jsp:include page="../tutorial-nav.jsp"><jsp:param name="prevLink" value="password_algos.jsp" /><jsp:param name="prevTitle" value="password_algos()" /><jsp:param name="nextLink" value="password_needs_rehash.jsp" /><jsp:param name="nextTitle" value="password_needs_rehash()" /><jsp:param name="currentLessonId" value="password_get_info" /></jsp:include>
            </article>
        </main>
