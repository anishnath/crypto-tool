        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content">
                ...
                <div class="lesson-body">
                    <p class="lead">The <code>file_get_contents()</code> function performs a specific operation.</p>

                    <h2>Syntax</h2>
                    <pre><code class="language-php">file_get_contents($param): mixed</code></pre>
                    ...
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="codeFile" value="php-functions/file_get_contents.php" />
                        <jsp:param name="language" value="php" />
                        <jsp:param name="editorId" value="file_get_contents-demo" />
                    </jsp:include>
