<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% request.setAttribute("currentFunction", "juliantojd" ); %>
        <!DOCTYPE html>
        <html lang="en">
        ...
        <head>
            ...
            <script
                type="application/ld+json">{"@context":"https://schema.org","@type":"TechArticle","headline":"PHP juliantojd() Function","datePublished":"2025-01-28","dateModified":"2025-01-28"}</script>
            <script
                type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Tutorials","item":"https://8gwifi.org/tutorials/"},{"@type":"ListItem","position":2,"name":"PHP Functions","item":"https://8gwifi.org/tutorials/php-functions/"},{"@type":"ListItem","position":3,"name":"juliantojd()"}]}</script>
                        ...
                        <%@ include file="../tutorial-sidebar-php-functions.jsp" %>
                            ...
                            <article class="tutorial-content">
                                <nav class="breadcrumb"><a
                                        ...
                                        Functions</a><span
                                        class="breadcrumb-separator">/</span><span>juliantojd()</span></nav>
                                ...
                                <div class="lesson-body">
                                    ...
                                    <h2>Syntax</h2>
                                    <pre><code class="language-php">juliantojd(int $month, int $day, int $year): int</code></pre>
                                    <h2>Try It Online</h2>
                                    <jsp:include page="../tutorial-compiler.jsp">
                                        <jsp:param name="codeFile" value="php-functions/juliantojd.php" />
                                ...
                                <jsp:include page="../tutorial-nav.jsp">
                                    ...
                                    <jsp:param name="nextLink" value="unixtojd.jsp" />
                                    <jsp:param name="nextTitle" value="unixtojd()" />
