<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%-- Lua Tutorial - Landing Page --%>
        ...
        <head>
            ...
            <title>Lua Tutorial - Learn Lua Programming | 8gwifi.org Tutorials</title>
            <meta name="description"
                content="Learn Lua programming from scratch with interactive examples. Free Lua tutorial for beginners to advanced with live code editor.">
            ...
            <script type="application/ld+json">
    {
        ...
        "description": "A comprehensive interactive course to learn Lua programming from scratch to advanced topics.",
        "provider": {
            "@type": "Organization",
            "name": "8gwifi.org",
                        ...
                        <%@ include file="../tutorial-sidebar-lua.jsp" %>
                            ...
                            <article class="tutorial-content" style="margin-right: 0;">
                                ...
                                <header class="lesson-header">
                                    <h1 class="lesson-title">Lua Tutorial</h1>
                                    <p
                                        style="font-size: var(--text-lg); color: var(--text-secondary); max-width: 600px;">
                                        Learn Lua programming from scratch with interactive examples. Master the
                                        lightweight, powerful scripting language used in games, embedded systems, and
                                        more.
                                    </p>
                                </header>
                                ...
                                <div class="lesson-body">
                                    <div style="display: grid; gap: var(--space-4); margin-top: var(--space-8);">
                                        <%-- Start Learning Card --%>
                                            <a href="<%=request.getContextPath()%>/tutorials/lua/intro.jsp" class="card"
                                            ...
                                            <%-- What You'll Learn --%>
                                                <div class="card">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>Functions, closures, and higher-order functions</li>
                                                        <li>Tables: Lua's powerful data structure</li>
                                                        <li>Metatables and metamethods</li>
                                                        <li>Object-Oriented Programming in Lua</li>
                                                        <li>Modules and code organization</li>
                                                        <li>Error handling and debugging</li>
                                                        <li>Advanced: Coroutines, file I/O, performance</li>
                                                    </ul>
                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Introduction, setup, first program</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    ...
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Operators, strings, control flow</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    ...
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Functions, closures, advanced</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    <strong style="color: var(--text-primary);">4.
                                                                        Tables & Metatables</strong>
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Tables, library, metatables, iterators</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    ...
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Classes, inheritance, modules</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    <strong style="color: var(--text-primary);">6.
                                                                        Modules & Error Handling</strong>
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Creating modules, errors, debugging</p>
                                                                </div>
                                                                <div
                                                                    style="padding: var(--space-3); background: var(--bg-secondary); border-radius: var(--radius-md);">
                                                                    ...
                                                                    <p
                                                                        style="margin: var(--space-1) 0 0; font-size: var(--text-sm); color: var(--text-muted);">
                                                                        Coroutines, file I/O, performance</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                    </div>
