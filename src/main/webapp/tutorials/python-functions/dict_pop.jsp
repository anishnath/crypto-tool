<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% request.setAttribute("currentFunction", "dict_pop" ); %>
        <!DOCTYPE html>
        <html lang="en">
            ...
            <script type="application/ld+json">
    {
        ...
        "@type": "TechArticle",
        "headline": "Python dict.pop() Method",
        "description": "The pop() method removes the element with the specified key.",
        "articleSection": "Python Dictionary Methods",
        "keywords": "python, dict, pop, remove",
        ...
        <body class="tutorial-body no-preview" data-lesson="python-functions-dict-pop">
                        ...
                        <%@ include file="../tutorial-sidebar-python-functions.jsp" %>
                            ...
                            <article class="tutorial-content" >
                                ...
                                <header class="lesson-header">
                                    <h1 class="lesson-title">Python dict.pop() Method</h1>
                                ...
                                <div class="lesson-body">
                                    <p class="lead">
                                        The <code>pop()</code> method removes the element with the specified key.
                                    </p>

                                    <h2>Syntax</h2>
                                    <pre
                                        class="language-python"><code>dictionary.pop(keyname, defaultvalue)</code></pre>
                                        ...
                                        <table class="reference-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Required. The keyname of the item you want to remove</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>Optional. A value to return if the specified key does not exist.
                                                        ...
                                                        specified key is found, an error is raised</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <h2>Return Value</h2>
                                    <p>The value of the removed item.</p>
                                    ...
                                    <jsp:include page="../tutorial-compiler.jsp">
                                        ...
                                        <jsp:param name="codeFile"
                                            value="python-functions/dict_pop.py" />
                                    </jsp:include>
                                    ...
                                    <div class="related-links">
                                        ...
                                        <a href="dict_clear.jsp" class="related-link">
                                            <span class="related-icon">🧹</span>
                                            <div>
