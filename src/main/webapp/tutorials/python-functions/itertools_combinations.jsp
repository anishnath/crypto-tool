...
<% request.setAttribute("currentFunction", "itertools_combinations"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "TechArticle",
        "headline": "Python itertools.combinations() Function",
        "description": "Generate all r-length combinations of elements for combinatorial problems and algorithms",
        "articleSection": "Python Itertools",
        "keywords": "python itertools, combinations, combinatorics, permutations, algorithm, math",
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" style="margin-right: 0;">
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span>itertools.combinations()</span>
                </nav>
                <header class="lesson-header">
                    <h1 class="lesson-title">Python itertools.combinations() Function</h1>
                    <div class="lesson-meta"><span>Itertools</span><span>•</span><span>Combinations</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>itertools.combinations()</code> function returns all r-length combinations of elements from an iterable.</p>
                    <h2>Syntax</h2>
                    <pre class="language-python"><code>itertools.combinations(iterable, r)</code></pre>
                    <h2>Return Value</h2>
                    <p>An iterator of tuples.</p>
                    <h2>Example</h2>
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="language" value="python" />
                        <jsp:param name="codeFile" value="python-functions/itertools_combinations.py" />
                    </jsp:include>
                </div>
