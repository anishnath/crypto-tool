<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% request.setAttribute("currentFunction", "datetime_strftime" ); %>
        ...
        <head>
            ...
            <title>Python datetime.strftime() - Format DateTime | Live Demo</title>
    ...
    <meta property="og:title" content="Python datetime.strftime() - Format DateTime | Live Demo">
    <meta property="og:description" content="Python datetime.strftime() formats datetime as string. Interactive examples. Syntax: dt.strftime(format). Custom date formatting. Try it online!">
    <meta property="og:image" content="https://8gwifi.org/tutorials/assets/images/python-logo.svg">
    <meta name="twitter:card" content="summary">

    <meta name="twitter:description" content="Python datetime.strftime() formats datetime as string. Interactive examples. Syntax: dt.strftime(format). Custom date formatting. Try it online!">            <link rel="canonical" href="https://8gwifi.org/tutorials/python-functions/datetime_strftime.jsp">
