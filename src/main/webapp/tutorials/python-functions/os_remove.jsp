...
<% request.setAttribute("currentFunction", "os_remove"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" style="margin-right: 0;">
                ...
                <header class="lesson-header">
                    <h1 class="lesson-title">Python os.remove() Method</h1>
                    <div class="lesson-meta"><span>OS & System</span><span>•</span><span>File System</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>os.remove()</code> method deletes a file.</p>
                    <h2>Syntax</h2>
                    <pre class="language-python"><code>os.remove(path)</code></pre>
                    <h2>Return Value</h2>
                    <p>None.</p>
                    <h2>Example</h2>
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="language" value="python" />
                        <jsp:param name="codeFile" value="python-functions/os_remove.py" />
                    </jsp:include>
                </div>
