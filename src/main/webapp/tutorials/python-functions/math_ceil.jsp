...
<% request.setAttribute("currentFunction", "math_ceil"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" >
                ...
                <header class="lesson-header">
                    <h1 class="lesson-title">Python math.ceil() Method</h1>
                    <div class="lesson-meta"><span>Math</span><span>•</span><span>Rounding</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>math.ceil()</code> method rounds a number up to the nearest integer.</p>
                    <h2>Syntax</h2>
                    <pre class="language-python"><code>math.ceil(x)</code></pre>
                    <h2>Return Value</h2>
                    <p>The smallest integer >= x.</p>
                    <h2>Example</h2>
