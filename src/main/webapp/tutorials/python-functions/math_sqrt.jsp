...
<% request.setAttribute("currentFunction", "math_sqrt"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" >
                ...
                <header class="lesson-header">
                    <h1 class="lesson-title">Python math.sqrt() Method</h1>
                    <div class="lesson-meta"><span>Math</span><span>•</span><span>Square Root</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>math.sqrt()</code> method returns the square root of a number.</p>
                    <h2>Syntax</h2>
                    <pre class="language-python"><code>math.sqrt(x)</code></pre>
                    <h2>Return Value</h2>
                    <p>The square root of x.</p>
                    <h2>Example</h2>
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="language" value="python" />
                        <jsp:param name="codeFile" value="python-functions/math_sqrt.py" />
                    </jsp:include>
                </div>
    </div>
