<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <script type="application/ld+json">
    {
        ...
        "@type": "TechArticle",
        "headline": "Python range() Function",
        ...
        "keywords": "python, range, sequence, loop",
        ...
        <body class="tutorial-body no-preview" data-lesson="python-functions-range">
                        ...
                        <%@ include file="../tutorial-sidebar-python-functions.jsp" %>
                            ...
                            <article class="tutorial-content" style="margin-right: 0;">
                                ...
                                <header class="lesson-header">
                                    <h1 class="lesson-title">Python range() Function</h1>
                                ...
                                <div class="lesson-body">
                                    <p class="lead">
                                        The <code>range()</code> function returns a sequence of numbers, starting from 0
                                        by default, and increments by 1 (by default), and stops before a specified
                                        number.
                                    </p>

                                    <h2>Syntax</h2>
                                    <pre class="language-python"><code>range(start, stop, step)</code></pre>
                                        ...
                                        <table class="reference-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Optional. An integer specifying at which position to start.
                                                        Default is 0</td>
                                                </tr>
                                                <tr>
                                                    <td><code>stop</code></td>
                                                    <td>Required. An integer specifying at which position to stop (not
                                                        included)</td>
                                                </tr>
                                                <tr>
                                                    <td><code>step</code></td>
                                                    <td>Optional. An integer specifying the incrementation. Default is 1
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <h2>Example</h2>
                                    <p>Using the <code>range()</code> function in loops:</p>

                                    <jsp:include page="../tutorial-compiler.jsp">
                                        <jsp:param name="language" value="python" />
                                        <jsp:param name="codeFile"
                                            value="python-functions/range.py" />
                                    </jsp:include>
