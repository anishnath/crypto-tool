<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <script type="application/ld+json">
    {
        ...
        "keywords": "python, min, minimum, math",
        ...
        <body class="tutorial-body no-preview" data-lesson="python-functions-min">
                        ...
                        <%@ include file="../tutorial-sidebar-python-functions.jsp" %>
                            ...
                            <article class="tutorial-content" >
                                ...
                                <header class="lesson-header">
                                    <h1 class="lesson-title">Python min() Function</h1>
                                ...
                                <div class="lesson-body">
                                    <p class="lead">
                                        The <code>min()</code> function returns the item with the lowest value, or the
                                    ...
                                    <h2>Syntax</h2>
                                    <pre class="language-python"><code>min(n1, n2, n3, ...)</code></pre>
                                    <p>Or</p>
                                    <pre class="language-python"><code>min(iterable)</code></pre>
                                    ...
                                    <h2>Return Value</h2>
                                    <p>The smallest item.</p>

                                    <h2>Example</h2>
                                    <p>Using the <code>min()</code> function:</p>

                                    <jsp:include page="../tutorial-compiler.jsp">
                                        <jsp:param name="language" value="python" />
                                        <jsp:param name="codeFile" value="python-functions/min.py" />
                                    </jsp:include>
