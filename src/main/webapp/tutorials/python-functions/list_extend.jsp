<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% request.setAttribute("currentFunction", "list_extend" ); %>
        <!DOCTYPE html>
        <html lang="en">
            ...
            <script type="application/ld+json">
    {
        ...
        "@type": "TechArticle",
        "headline": "Python list.extend() Method",
        "description": "The extend() method adds the specified list elements (or any iterable) to the end of the current list.",
        "articleSection": "Python List Methods",
        "keywords": "python, list, extend, merge",
        ...
        <body class="tutorial-body no-preview" data-lesson="python-functions-list-extend">
                        ...
                        <%@ include file="../tutorial-sidebar-python-functions.jsp" %>
                            ...
                            <article class="tutorial-content" >
                                <nav class="breadcrumb">
                                    ...
                                    <span class="breadcrumb-separator">/</span>
                                    <span>list.extend()</span>
                                </nav>

                                <header class="lesson-header">
                                    <h1 class="lesson-title">Python list.extend() Method</h1>
                                ...
                                <div class="lesson-body">
                                    <p class="lead">
                                        The <code>extend()</code> method adds the specified list elements (or any
                                        ...
                                        <table class="reference-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Required. Any iterable (list, set, tuple, etc.)</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <h2>Example</h2>
                                    <p>Using the <code>extend()</code> method:</p>

                                    <jsp:include page="../tutorial-compiler.jsp">
                                        <jsp:param name="language" value="python" />
                                        <jsp:param name="codeFile"
                                            value="python-functions/list_extend.py" />
                                    </jsp:include>
