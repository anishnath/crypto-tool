...
<% request.setAttribute("currentFunction", "re_split"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" style="margin-right: 0;">
                ...
                <header class="lesson-header">
                    <h1 class="lesson-title">Python re.split() Method</h1>
                    <div class="lesson-meta"><span>Regular Expressions</span><span>•</span><span>Split</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>re.split()</code> method splits a string by pattern matches.</p>
                    <h2>Syntax</h2>
                    <pre class="language-python"><code>re.split(pattern, string, maxsplit=0)</code></pre>
                    <h2>Return Value</h2>
                    <p>A list of strings.</p>
                    <h2>Example</h2>
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="language" value="python" />
                        <jsp:param name="codeFile" value="python-functions/re_split.py" />
                    </jsp:include>
                </div>
