<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% request.setAttribute("currentFunction", "datetime_date" ); %>
        ...
        <head>
            ...
            <title>Python datetime.date() Constructor - Create Date | 8gwifi.org</title>
            ...
            <link rel="canonical" href="https://8gwifi.org/tutorials/python-functions/datetime_date.jsp">
