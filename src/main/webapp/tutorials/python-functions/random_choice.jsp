...
<% request.setAttribute("currentFunction", "random_choice"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" >
                ...
                <header class="lesson-header">
                    <h1 class="lesson-title">Python random.choice() Method</h1>
                    <div class="lesson-meta"><span>Random</span><span>•</span><span>Choice</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>random.choice()</code> method returns a random element from a non-empty sequence.</p>
                    <h2>Syntax</h2>
                    <pre class="language-python"><code>random.choice(seq)</code></pre>
                    <h2>Return Value</h2>
                    <p>A random element from the sequence.</p>
                    <h2>Example</h2>
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="language" value="python" />
                        <jsp:param name="codeFile" value="python-functions/random_choice.py" />
                    </jsp:include>
                </div>
    </div>
