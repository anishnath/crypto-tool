...
<% request.setAttribute("currentFunction", "random_shuffle"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" >
                ...
                <header class="lesson-header">
                    <h1 class="lesson-title">Python random.shuffle() Method</h1>
                    <div class="lesson-meta"><span>Random</span><span>•</span><span>Shuffle</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>random.shuffle()</code> method shuffles a list in place.</p>
                    <h2>Syntax</h2>
                    <pre class="language-python"><code>random.shuffle(x)</code></pre>
                    <h2>Return Value</h2>
                    <p>None (modifies list in-place).</p>
                    <h2>Example</h2>
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="language" value="python" />
                        <jsp:param name="codeFile" value="python-functions/random_shuffle.py" />
                    </jsp:include>
                </div>
    </div>
