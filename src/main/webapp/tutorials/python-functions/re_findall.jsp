...
<% request.setAttribute("currentFunction", "re_findall"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" >
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span>re.findall()</span>
                </nav>
                <header class="lesson-header">
                    <h1 class="lesson-title">Python re.findall() Method</h1>
                    <div class="lesson-meta"><span>Regular Expressions</span><span>•</span><span>Find All</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>re.findall()</code> method returns a list of all matches in the string.</p>
                    <h2>Syntax</h2>
                    ...
                    <div class="table-responsive">
                        <table class="reference-table">
                            ...
                            <tbody>
                                <tr><td><code>pattern</code></td><td>Required. The regex pattern.</td></tr>
                                <tr><td><code>string</code></td><td>Required. The string to search.</td></tr>
                            </tbody>
                        </table>
                    </div>
                    <h2>Return Value</h2>
                    <p>A list of all matches.</p>
                    <h2>Example</h2>
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="language" value="python" />
                        <jsp:param name="codeFile" value="python-functions/re_findall.py" />
                    </jsp:include>
                    <h2>Related Functions</h2>
                    <div class="related-links">
                        <a href="re_search.jsp" class="related-link">
                            <span class="related-icon">🔍</span>
                            <div><strong>re.search()</strong><span>Find first</span></div>
                        </a>
                    </div>
                </div>
    </div>
