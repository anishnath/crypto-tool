<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% request.setAttribute("currentFunction", "dict_items" ); %>
        <!DOCTYPE html>
        <html lang="en">
            ...
            <script type="application/ld+json">
    {
        ...
        "@type": "TechArticle",
        "headline": "Python dict.items() Method",
        "description": "The items() method returns a view object. The view object contains the key-value pairs of the dictionary, as tuples in a list.",
        "articleSection": "Python Dictionary Methods",
        "keywords": "python, dict, items, view",
        ...
        <body class="tutorial-body no-preview" data-lesson="python-functions-dict-items">
                        ...
                        <%@ include file="../tutorial-sidebar-python-functions.jsp" %>
                            ...
                            <article class="tutorial-content" >
                                ...
                                <header class="lesson-header">
                                    <h1 class="lesson-title">Python dict.items() Method</h1>
                                ...
                                <div class="lesson-body">
                                    <p class="lead">
                                        The <code>items()</code> method returns a view object. The view object contains
                                    ...
                                    <h2>Return Value</h2>
                                    <p>A view object containing the key-value pairs.</p>

                                    <h2>Example</h2>
                                    <p>Using the <code>items()</code> method:</p>

                                    <jsp:include page="../tutorial-compiler.jsp">
                                        <jsp:param name="language" value="python" />
                                        <jsp:param name="codeFile"
                                            value="python-functions/dict_items.py" />
                                    </jsp:include>
