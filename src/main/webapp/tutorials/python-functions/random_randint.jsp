...
<% request.setAttribute("currentFunction", "random_randint"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="tutorial-main">
            ...
            <article class="tutorial-content" style="margin-right: 0;">
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-separator">/</span>
                    <span>random.randint()</span>
                </nav>
                <header class="lesson-header">
                    <h1 class="lesson-title">Python random.randint() Method</h1>
                    <div class="lesson-meta"><span>Random</span><span>•</span><span>Integer</span></div>
                </header>
                <div class="lesson-body">
                    <p class="lead">The <code>random.randint()</code> method returns a random integer between two values (inclusive).</p>
                    <h2>Syntax</h2>
                    <pre class="language-python"><code>random.randint(a, b)</code></pre>
                    <h2>Return Value</h2>
                    <p>A random integer N such that a <= N <= b.</p>
                    <h2>Example</h2>
                    <jsp:include page="../tutorial-compiler.jsp">
                        <jsp:param name="language" value="python" />
                        <jsp:param name="codeFile" value="python-functions/random_randint.py" />
                    </jsp:include>
                </div>
