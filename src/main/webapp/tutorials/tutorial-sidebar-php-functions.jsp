                                            ...
                                            <ul class="nav-items">
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/checkdate.jsp"
                                                        class="nav-link <%= " checkdate".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        checkdate()
                                                    </a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/getdate.jsp"
                                                        class="nav-link <%= " getdate".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        getdate()
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/gettimeofday.jsp"
                                                        class="nav-link <%= " gettimeofday".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        gettimeofday()
                                                    </a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/gmmktime.jsp"
                                                        class="nav-link <%= " gmmktime".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        gmmktime()
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/gmstrftime.jsp"
                                                        class="nav-link <%= " gmstrftime".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        gmstrftime()
                                                    </a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/localtime.jsp"
                                                        class="nav-link <%= " localtime".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        localtime()
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/microtime.jsp"
                                                        class="nav-link <%= " microtime".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        microtime()
                                                    </a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/strftime.jsp"
                                                        class="nav-link <%= " strftime".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        strftime()
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/strptime.jsp"
                                                        class="nav-link <%= " strptime".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        strptime()
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/strtotime.jsp"
                                                        class="nav-link <%= " strtotime".equals(currentFunction)
                                                        ? "active" : "" %>">
                                                        strtotime()
                                                    </a>
                                                </li>
                                                ...
                                                <ul class="nav-items">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/cal_from_jd.jsp"
                                                            class="nav-link <%= " cal_from_jd".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            cal_from_jd()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/cal_info.jsp"
                                                            class="nav-link <%= " cal_info".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            cal_info()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/cal_to_jd.jsp"
                                                            class="nav-link <%= " cal_to_jd".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            cal_to_jd()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/easter_date.jsp"
                                                            class="nav-link <%= " easter_date".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            easter_date()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/easter_days.jsp"
                                                            class="nav-link <%= " easter_days".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            easter_days()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/frenchtojd.jsp"
                                                            class="nav-link <%= " frenchtojd".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            frenchtojd()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/gregoriantojd.jsp"
                                                            class="nav-link <%= " gregoriantojd".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            gregoriantojd()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/jddayofweek.jsp"
                                                            class="nav-link <%= " jddayofweek".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            jddayofweek()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/jdmonthname.jsp"
                                                            class="nav-link <%= " jdmonthname".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            jdmonthname()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/jdtofrench.jsp"
                                                            class="nav-link <%= " jdtofrench".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            jdtofrench()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/jdtogregorian.jsp"
                                                            class="nav-link <%= " jdtogregorian".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            jdtogregorian()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/jdtojewish.jsp"
                                                            class="nav-link <%= " jdtojewish".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            jdtojewish()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/jdtojulian.jsp"
                                                            class="nav-link <%= " jdtojulian".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            jdtojulian()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/jdtounix.jsp"
                                                            class="nav-link <%= " jdtounix".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            jdtounix()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/jewishtojd.jsp"
                                                            class="nav-link <%= " jewishtojd".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            jewishtojd()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/juliantojd.jsp"
                                                            class="nav-link <%= " juliantojd".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            juliantojd()
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/unixtojd.jsp"
                                                            class="nav-link <%= " unixtojd".equals(currentFunction)
                                                            ? "active" : "" %>">
                                                            unixtojd()
                                                        </a>
                                                    </li>
                                            ...
                                            <%-- JSON Functions --%>
                                                ...
                                                <%-- File Functions --%>
                                                        ...
                                                        <ul class="nav-items">
                                                            <li class="nav-item">
                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/file_get_contents.jsp"
                                                                    class="nav-link <%= "file_get_contents".equals(currentFunction)
                                                                    ? "active" : "" %>">
                                                                    file_get_contents()
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/file_put_contents.jsp"
                                                                    class="nav-link <%= "file_put_contents".equals(currentFunction)
                                                                    ? "active" : "" %>">
                                                                    file_put_contents()
                                                                </a>
                                                            </li>
                                                    ...
                                                    <%-- Hash/Crypto Functions --%>
                                                        <div class="nav-section">
                                                            <div class="nav-section-title">Hash/Crypto Functions</div>
                                                            <ul class="nav-items">
                                                                <li class="nav-item">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/hash_hmac_algos.jsp"
                                                                        class="nav-link <%= "hash_hmac_algos".equals(currentFunction)
                                                                        ? "active" : "" %>">
                                                                        hash_hmac_algos()
                                                                    </a>
                                                                </li>
                                                        ...
                                                        <%-- Password Hashing Functions --%>
                                                            <div class="nav-section">
                                                                <div class="nav-section-title">Password Hashing</div>
                                                                <ul class="nav-items">
                                                                    <li class="nav-item">
                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/password_hash.jsp"
                                                                            class="nav-link <%= "password_hash".equals(currentFunction)
                                                                            ? "active" : "" %>">
                                                                            password_hash()
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/password_verify.jsp"
                                                                            class="nav-link <%= "password_verify".equals(currentFunction)
                                                                            ? "active" : "" %>">
                                                                            password_verify()
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/password_algos.jsp"
                                                                            class="nav-link <%= "password_algos".equals(currentFunction)
                                                                            ? "active" : "" %>">
                                                                            password_algos()
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/password_get_info.jsp"
                                                                            class="nav-link <%= "password_get_info".equals(currentFunction)
                                                                            ? "active" : "" %>">
                                                                            password_get_info()
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/password_needs_rehash.jsp"
                                                                            class="nav-link <%= "password_needs_rehash".equals(currentFunction)
                                                                            ? "active" : "" %>">
                                                            ...
                                                            <%-- Regular Expressions --%>
                                                                <div class="nav-section">
                                                                    <div class="nav-section-title">Regular Expressions
                                                                    </div>
                                                                    <ul class="nav-items">
                                                                        <li class="nav-item">
                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/preg_match.jsp"
                                                                                class="nav-link <%= "preg_match".equals(currentFunction)
                                                                                ? "active" : "" %>">
                                                                                preg_match()
                                                                            </a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/preg_match_all.jsp"
                                                                                class="nav-link <%= "preg_match_all".equals(currentFunction)
                                                                                ? "active" : "" %>">
                                                                                preg_match_all()
                                                                            </a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/preg_replace.jsp"
                                                                                class="nav-link <%= "preg_replace".equals(currentFunction)
                                                                                ? "active" : "" %>">
                                                                                preg_replace()
                                                                            </a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/preg_replace_callback.jsp"
                                                                                class="nav-link <%= "preg_replace_callback".equals(currentFunction)
                                                                                ? "active" : "" %>">
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/preg_split.jsp"
                                                                                class="nav-link <%= "preg_split".equals(currentFunction)
                                                                                ? "active" : "" %>">
                                                                                preg_split()
                                                                            </a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/preg_grep.jsp"
                                                                                class="nav-link <%= "preg_grep".equals(currentFunction)
                                                                                ? "active" : "" %>">
                                                                                preg_grep()
                                                                            </a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/preg_filter.jsp"
                                                                                class="nav-link <%= "preg_filter".equals(currentFunction)
                                                                                ? "active" : "" %>">
                                                                                preg_filter()
                                                                            </a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/preg_quote.jsp"
                                                                                class="nav-link <%= "preg_quote".equals(currentFunction)
                                                                                ? "active" : "" %>">
                                                                                preg_quote()
                                                                            </a>
                                                                        </li>
                                                                ...
                                                                <%-- URL Functions --%>
                                                                        ...
                                                                        <ul class="nav-items">
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/urlencode.jsp"
                                                                                    class="nav-link <%= "urlencode".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    urlencode()
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/urldecode.jsp"
                                                                                    class="nav-link <%= "urldecode".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    urldecode()
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/rawurlencode.jsp"
                                                                                    class="nav-link <%= "rawurlencode".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    rawurlencode()
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/rawurldecode.jsp"
                                                                                    class="nav-link <%= "rawurldecode".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    rawurldecode()
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/base64_encode.jsp"
                                                                                    class="nav-link <%= "base64_encode".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    base64_encode()
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/base64_decode.jsp"
                                                                                    class="nav-link <%= "base64_decode".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    base64_decode()
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/parse_url.jsp"
                                                                                    class="nav-link <%= "parse_url".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    parse_url()
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/http_build_query.jsp"
                                                                                    class="nav-link <%= "http_build_query".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    http_build_query()
                                                                                </a>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <a href="<%=request.getContextPath()%>/tutorials/php-functions/get_meta_tags.jsp"
                                                                                    class="nav-link <%= "get_meta_tags".equals(currentFunction)
                                                                                    ? "active" : "" %>">
                                                                                    get_meta_tags()
                                                                                </a>
                                                                            </li>
                                                                    ...
                                                                    <%-- Network Functions --%>
                                                                            ...
                                                                            <ul class="nav-items">
                                                                                <li class="nav-item">
                                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/gethostbyaddr.jsp"
                                                                                        class="nav-link <%= "gethostbyaddr".equals(currentFunction)
                                                                                        ? "active" : "" %>">
                                                                                        gethostbyaddr()
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/gethostbyname.jsp"
                                                                                        class="nav-link <%= "gethostbyname".equals(currentFunction)
                                                                                        ? "active" : "" %>">
                                                                                        gethostbyname()
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/gethostbynamel.jsp"
                                                                                        class="nav-link <%= "gethostbynamel".equals(currentFunction)
                                                                                        ? "active" : "" %>">
                                                                                        gethostbynamel()
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/getmxrr.jsp"
                                                                                        class="nav-link <%= "getmxrr".equals(currentFunction)
                                                                                        ? "active" : "" %>">
                                                                                        getmxrr()
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/getservbyname.jsp"
                                                                                        class="nav-link <%= "getservbyname".equals(currentFunction)
                                                                                        ? "active" : "" %>">
                                                                                        getservbyname()
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/getservbyport.jsp"
                                                                                        class="nav-link <%= "getservbyport".equals(currentFunction)
                                                                                        ? "active" : "" %>">
                                                                                        getservbyport()
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/ip2long.jsp"
                                                                                        class="nav-link <%= "ip2long".equals(currentFunction)
                                                                                        ? "active" : "" %>">
                                                                                        ip2long()
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a href="<%=request.getContextPath()%>/tutorials/php-functions/long2ip.jsp"
                                                                                        class="nav-link <%= "long2ip".equals(currentFunction)
                                                                                        ? "active" : "" %>">
                                                                                        long2ip()
                                                                                    </a>
                                                                                </li>
                                                                        ...
                                                                        <%-- Variable Functions --%>
                                                                            <div class="nav-section">
                                                                                <div class="nav-section-title">Variable
                                                                                    Functions</div>
                                                                                <ul class="nav-items">
                                                                                    <li class="nav-item">
                                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/isset.jsp"
                                                                                            class="nav-link <%= "isset".equals(currentFunction)
                                                                                            ? "active" : "" %>">
                                                                                            isset()
                                                                                        </a>
                                                                                    </li>
                                                                                    <li class="nav-item">
                                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/empty.jsp"
                                                                                            class="nav-link <%= "empty".equals(currentFunction)
                                                                                            ? "active" : "" %>">
                                                                                            empty()
                                                                                        </a>
                                                                                    </li>
                                                                                    <li class="nav-item">
                                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/var_dump.jsp"
                                                                                            class="nav-link <%= "var_dump".equals(currentFunction)
                                                                                            ? "active" : "" %>">
                                                                                            var_dump()
                                                                                        </a>
                                                                                    </li>
                                                                                    <li class="nav-item">
                                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/print_r.jsp"
                                                                                            class="nav-link <%= "print_r".equals(currentFunction)
                                                                                            ? "active" : "" %>">
                                                                                            print_r()
                                                                                        </a>
                                                                                    </li>
                                                                                    <li class="nav-item">
                                                                                        <a href="<%=request.getContextPath()%>/tutorials/php-functions/gettype.jsp"
                                                                                            class="nav-link <%= "gettype".equals(currentFunction)
                                                                                            ? "active" : "" %>">
                                                                                            gettype()
                                                                                        </a>
                                                                                    </li>
                                                                                    ...
                                                                                    <ul class="nav-items">
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/hex2bin.jsp"
                                                                                                class="nav-link <%= "hex2bin".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                hex2bin()
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/pack.jsp"
                                                                                                class="nav-link <%= "pack".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                pack()
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/serialize.jsp"
                                                                                                class="nav-link <%= "serialize".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                serialize()
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/token_name.jsp"
                                                                                                class="nav-link <%= "token_name".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                token_name()
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/uniqid.jsp"
                                                                                                class="nav-link <%= "uniqid".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                uniqid()
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/unpack.jsp"
                                                                                                class="nav-link <%= "unpack".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                unpack()
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/unserialize.jsp"
                                                                                                class="nav-link <%= "unserialize".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                unserialize()
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/zlib_decode.jsp"
                                                                                                class="nav-link <%= "zlib_decode".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                zlib_decode()
                                                                                            </a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                            <a href="<%=request.getContextPath()%>/tutorials/php-functions/zlib_encode.jsp"
                                                                                                class="nav-link <%= "zlib_encode".equals(currentFunction)
                                                                                                ? "active" : "" %>">
                                                                                                zlib_encode()
                                                                                            </a>
                                                                                        </li>
