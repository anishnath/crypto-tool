...
(function() {
    ...
    if (worksheetBtn) worksheetBtn.addEventListener('click', function() {
        var w = window.open('', '_blank');
        if (!w) return;
        w.document.write('<!DOCTYPE html><html><head><title>PDE Practice Worksheet</title><style>body{font-family:Georgia,serif;max-width:700px;margin:2rem auto;padding:1rem;} .problem{margin-bottom:2rem;padding:1rem;border:1px solid #e2e8f0;border-radius:8px;} .work-space{min-height:120px;border:1px dashed #cbd5e1;border-radius:4px;margin-top:0.5rem;padding:0.5rem;color:#94a3b8;font-size:0.8rem;} h1{color:#0891b2;} h3{margin-top:0;}</style></head><body>' +
            '<h1>PDE Practice Worksheet</h1><p style="color:#64748b;">Generated by 8gwifi.org PDE Solver Calculator</p><hr>' +
            '<div class="problem"><h3>1. Heat Equation</h3><p>Solve u_t = 2 u_xx on [0, pi] with u(0,t)=u(pi,t)=0 and u(x,0)=sin(x). What is the stability condition for explicit FD?</p><div class="work-space">Show your work here...</div></div>' +
            '<div class="problem"><h3>2. Wave Equation</h3><p>Solve u_tt = 4 u_xx on [0, 1] with u(0,t)=u(1,t)=0, u(x,0)=sin(2*pi*x), u_t(x,0)=0. Write the CFL condition.</p><div class="work-space">Show your work here...</div></div>' +
            '<div class="problem"><h3>3. Laplace Equation</h3><p>Solve u_xx + u_yy = 0 on the unit square with u=0 on three sides and u=sin(pi*x) on top. Use separation of variables to find the analytical solution.</p><div class="work-space">Show your work here...</div></div>' +
            '<div class="problem"><h3>4. Poisson Equation</h3><p>Solve nabla^2 u = -1 on [0,1]x[0,1] with u=0 on all boundaries. Describe the Jacobi iterative method.</p><div class="work-space">Show your work here...</div></div>' +
            '<div class="problem"><h3>5. Transport Equation</h3><p>Solve u_t + 3 u_x = 0 with u(x,0) = e^(-10(x-1)^2). What is the exact solution? Describe the upwind scheme.</p><div class="work-space">Show your work here...</div></div>' +
            '<div class="problem"><h3>6. Boundary Conditions</h3><p>Explain the difference between Dirichlet, Neumann, and Robin boundary conditions. Give a physical example of each.</p><div class="work-space">Show your work here...</div></div>' +
            '<div class="problem"><h3>7. Schrodinger Equation</h3><p>For a particle in an infinite square well of width L, find the first 3 energy levels. Write the normalized wavefunctions.</p><div class="work-space">Show your work here...</div></div>' +
            '</body></html>');
        w.document.close();
        w.print();
    });
