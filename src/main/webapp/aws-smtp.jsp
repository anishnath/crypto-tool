...
<html>
<head>
    <title>AWS SES SMTP Password Generator – From Access Key (Secure, Free) | 8gwifi.org</title>
    <meta content='text/html; charset=UTF-8' http-equiv='Content-Type'>
    <meta name="description" content="Derive AWS SES SMTP passwords from Access Keys securely in your browser. Free, no signup, 100% client-side. Copy credentials in one click."/>
    <meta name="keywords" content="aws ses smtp password, smtp from aws access key, ses smtp generator, aws ses smtp credentials"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="canonical" href="https://8gwifi.org/aws-smtp.jsp" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="AWS SES SMTP Password Generator – Secure & Free" />
    <meta property="og:description" content="Derive AWS SES SMTP passwords from Access Keys securely. Free, no signup. 100% client-side." />
    <meta property="og:url" content="https://8gwifi.org/aws-smtp.jsp" />
    <meta property="og:site_name" content="8gwifi.org" />
    <meta property="og:image" content="https://8gwifi.org/images/site/aws-smtp.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="AWS SES SMTP Password Generator – Secure & Free" />
    <meta name="twitter:description" content="Derive AWS SES SMTP passwords from Access Keys securely. Free, no signup. 100% client-side." />
    <meta name="twitter:image" content="https://8gwifi.org/images/site/aws-smtp.png" />
    ...
    <script type="application/ld+json">
{
  ...
  "@type": "WebApplication",
  "name": "AWS SES SMTP Password Generator",
  "description": "Derive AWS SES SMTP passwords from Access Keys securely in-browser. Free and client-side.",
  ...
  "screenshot": "https://8gwifi.org/images/site/aws-smtp.png"
}
    </script>
    <script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    {"@type": "Question","name": "Are my AWS keys stored?","acceptedAnswer": {"@type": "Answer","text": "No. Conversion is client-side in your browser and keys are not stored."}},
    {"@type": "Question","name": "Which regions are supported?","acceptedAnswer": {"@type": "Answer","text": "All SES-supported regions work. Choose the same region where SES is enabled for your account."}},
    {"@type": "Question","name": "What IAM permissions are needed?","acceptedAnswer": {"@type": "Answer","text": "No API calls are made; generation is deterministic from your Secret Key. Use scoped, temporary credentials for best security."}},
    {"@type": "Question","name": "Can I rotate SMTP credentials?","acceptedAnswer": {"@type": "Answer","text": "Yes. Rotate your Access Keys in IAM; regenerate SMTP password with the new key."}}
  ]
}
    </script>
...
<h1 class="mt-4">AWS SES SMTP Password Generator</h1>
