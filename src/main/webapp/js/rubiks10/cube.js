/**
 * 10×10×10 cube state model — sister of {@link js/rubiks9/cube.js} with N=10.
 *
 * 600 stickers, 6 faces × 100 stickers each, indexed row-major within a
 * face.  Per-face offsets:  U=0  R=100  F=200  D=300  L=400  B=500.
 */
...
export const N = 10;
export const STICKERS_PER_FACE = N * N;                       // 100
export const TOTAL_STICKERS    = 6 * STICKERS_PER_FACE;       // 600
...
export const GRID_COLS = 4 * N;  // 40
export const GRID_ROWS = 3 * N;  // 30
