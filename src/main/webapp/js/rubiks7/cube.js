/**
 * 7×7×7 cube state model — sister of {@link js/rubiks5/cube.js} with N=7.
 *
 * 294 stickers, 6 faces × 49 stickers each, indexed row-major within a
 * face.  Per-face offsets:  U=0  R=49  F=98  D=147  L=196  B=245.
 */
...
export const N = 7;
export const STICKERS_PER_FACE = N * N;                       // 49
export const TOTAL_STICKERS    = 6 * STICKERS_PER_FACE;       // 294
...
export const GRID_COLS = 4 * N;  // 28
export const GRID_ROWS = 3 * N;  // 21
