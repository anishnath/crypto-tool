/**
 * SVG net renderer for the 7×7 cube.  Smaller stickers to keep the net
 * width comparable to the other sizes.
 */

import { FACE_COLORS, FACES, GRID_COLS, GRID_ROWS, PLACEMENTS, TOTAL_STICKERS } from './cube.js';

const STICKER_SIZE = 16;   // 28 cols × 16 = 448 px wide
const STICKER_GAP  = 1.5;
const RADIUS       = 1.5;
...
export function mountCubeNet(host, opts = {}) {
    ...
    svg.setAttribute('aria-label', "7×7 Rubik's cube unfolded net");
    ...
    function paint() {
        ...
        for (const p of PLACEMENTS) {
            ...
            r.setAttribute('stroke-width', isHi ? 1.2 : 0.4);
