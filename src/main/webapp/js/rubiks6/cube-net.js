/**
 * SVG net renderer for the 6×6 cube — port of {@code rubiks5/cube-net.js}
 * with N=6 and tighter stickers.
 */

import { FACE_COLORS, FACES, GRID_COLS, GRID_ROWS, PLACEMENTS, TOTAL_STICKERS } from './cube.js';

const STICKER_SIZE = 18;   // 24 cols × 18 = 432 px wide
...
export function mountCubeNet(host, opts = {}) {
    ...
    svg.setAttribute('aria-label', "6×6 Rubik's cube unfolded net");
    ...
    function paint() {
        ...
        for (const p of PLACEMENTS) {
            ...
            r.setAttribute('stroke-width', isHi ? 1.5 : 0.5);
