/**
 * 6×6×6 cube state model — sister of {@link js/rubiks5/cube.js} with N=6.
 *
 * 216 stickers, 6 faces × 36 stickers each, indexed row-major within a
 * face.  Per-face offsets:  U=0  R=36  F=72  D=108  L=144  B=180.
 */
...
export const N = 6;
export const STICKERS_PER_FACE = N * N;                       // 36
export const TOTAL_STICKERS    = 6 * STICKERS_PER_FACE;       // 216
...
export const GRID_COLS = 4 * N;  // 24
export const GRID_ROWS = 3 * N;  // 18
