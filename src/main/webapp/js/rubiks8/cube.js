/**
 * 8×8×8 cube state model — sister of {@link js/rubiks7/cube.js} with N=8.
 *
 * 384 stickers, 6 faces × 64 stickers each, indexed row-major within a
 * face.  Per-face offsets:  U=0  R=64  F=128  D=192  L=256  B=320.
 */
...
export const N = 8;
export const STICKERS_PER_FACE = N * N;                       // 64
export const TOTAL_STICKERS    = 6 * STICKERS_PER_FACE;       // 384
...
export const GRID_COLS = 4 * N;  // 32
export const GRID_ROWS = 3 * N;  // 24
