/**
 * SVG net renderer for the 8×8 cube.  Smaller stickers (14 px) keep the
 * net width comparable to the 7×7 net.
 */

import { FACE_COLORS, FACES, GRID_COLS, GRID_ROWS, PLACEMENTS, TOTAL_STICKERS } from './cube.js';

const STICKER_SIZE = 14;   // 32 cols × 14 = 448 px wide
const STICKER_GAP  = 1.2;
const RADIUS       = 1.5;
...
export function mountCubeNet(host, opts = {}) {
    ...
    svg.setAttribute('aria-label', "8×8 Rubik's cube unfolded net");
    ...
    function paint() {
        ...
        for (const p of PLACEMENTS) {
            ...
            r.setAttribute('stroke-width', isHi ? 1 : 0.35);
