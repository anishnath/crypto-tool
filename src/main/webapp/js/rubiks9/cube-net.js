/**
 * SVG net renderer for the 9×9 cube.  12 px stickers keep the net width
 * (36 cols × 12 = 432 px) comparable to the smaller sizes.
 */

import { FACE_COLORS, FACES, GRID_COLS, GRID_ROWS, PLACEMENTS, TOTAL_STICKERS } from './cube.js';

const STICKER_SIZE = 12;
const STICKER_GAP  = 1;
const RADIUS       = 1.2;
...
export function mountCubeNet(host, opts = {}) {
    ...
    svg.setAttribute('aria-label', "9×9 Rubik's cube unfolded net");
    ...
    function paint() {
        ...
        for (const p of PLACEMENTS) {
            ...
            r.setAttribute('stroke-width', isHi ? 0.9 : 0.3);
