/* Periodic table element data (118 elements, ~28 fields each).
   Reused verbatim from periodic-table-cli — MIT License, (c) 2022 Spiro Metaxas
   https://github.com/spirometaxas/periodic-table-cli
   Only the export line is changed (CommonJS -> browser global). */
window.PT_DATA = { 
    elements: [
        {
            "atomicNumber": 1,
