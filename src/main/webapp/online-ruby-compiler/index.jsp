...
<%
request.setAttribute("pageTitle", "AI Ruby Compiler - Run, Fix & Explain Ruby Code Free");
...
request.setAttribute("languageFaqHtml",
    "<p><strong>Which Ruby versions are available?</strong> Ruby 3.1, 3.2, and 3.3 are available.</p>" +
    "<p><strong>How do I share code?</strong> Click Share to generate a snippet URL.</p>" +
    "<p><strong>Are gems supported?</strong> Use self‑contained examples; gem availability varies by template.</p>");
