...
<%}%>
<br>
<b>Any private key value that you enter or we generate is not stored on this site, this tool is provided via an HTTPS URL to ensure that private keys cannot be stolen, for extra security <a href="https://goo.gl/forms/y6xGIfC3kxPTFims2" target="_blank" rel="noopener" >run </a> this software on your network, no cloud dependency</b></br>
Reader Offer The Modern Cryptography CookBook for Just  <a href="http://leanpub.com/crypto/c/NPsT3TZmqrNS" target="_blank" rel="noopener"> $9</a> Avail Discount coupon first <a href="http://leanpub.com/crypto/c/NPsT3TZmqrNS" target="_blank" rel="noopener"> 100 </a>reader. No hurry read the sample chapters <a href="https://8gwifi.org/docs/pki.jsp">here</a> first
<p><iframe width='160' height='400' src='https://leanpub.com/crypto/embed' frameborder='0' allowtransparency='true'></iframe></p>