...
<%}%>
<br>
<b>Any private key value that you enter or we generate is not stored on this site, this tool is provided via an HTTPS URL to ensure that private keys cannot be stolen, for extra security <a href="https://goo.gl/forms/y6xGIfC3kxPTFims2" target="_blank" rel="noopener" >run </a> this software on your network, no cloud dependency when purchashing cryptograpby Cookbook</b></br>
