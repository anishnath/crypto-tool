                ...
                <div class="card">
                    ...
                    <div id="collapseSharing" class="collapse" aria-labelledby="headingSharing" data-parent="#sidebarAccordion">
                        <div class="card-body p-2">
                            <ul class="list-unstyled mb-0 small">
                                <li><a href="pgp-upload.jsp">PGP Send Encrypt files</a></li>
                                <li><a href="securebin.jsp" title="Share a one‑time secret with end‑to‑end encryption">Share Secret</a></li>
                        ...
                        <div id="collapseMath" class="collapse" aria-labelledby="headingMath" data-parent="#sidebarAccordion">
                            <div class="card-body p-2">
                                <ul class="list-unstyled mb-0 small">
                                    ...
                                    <li><a href="system-equations-solver.jsp">System of Equations Solver (2x2, 3x3)</a></li>
                                    <li><a href="logarithm-calculator.jsp">Logarithm Calculator</a></li>
                                    <li><a href="exponent-calculator.jsp">Exponent Calculator (Laws of Exponents)</a></li>
                                    <li><a href="radical-simplifier.jsp">Radical Simplifier (√, ∛, Rationalize)</a></li>
                                    <li><a href="inequality-solver.jsp">Inequality Solver (Linear, Quadratic, Polynomial)</a></li>
                                    ...
                                    <li><a href="pascals-triangle-explorer.jsp">Pascal's Triangle Explorer</a></li>
                                    <li><a href="collatz-conjecture.jsp">Collatz Conjecture (3n+1 Problem)</a></li>
                        ...
                        <div id="collapsePhysics" class="collapse" aria-labelledby="headingPhysics" data-parent="#sidebarAccordion">
                            <div class="card-body p-2">
                                <ul class="list-unstyled mb-0 small">
                                    ...
                                    <li><a href="lens-mirror-calculator.jsp">Lens Equation & Mirror Formula Calculator</a></li>
