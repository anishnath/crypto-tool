...
<script type="application/ld+json">
{
	...
	"@type": "WebApplication",
	"name": "Ping & Location Tool",
    "image" : "https://github.com/anishnath/crypto-tool/blob/master/ping.png",
	"description": "Online ping tool to test connectivity to IPv4 and IPv6 addresses. Get response times, geolocation data, and network path information.",
	...
	"keywords": "ping tool, ipv4 ping, ipv6 ping, network connectivity, response time, geolocation, network tools, ping online",
	"about": {
		"@type": "Thing",
		"name": "Network Connectivity",
		"description": "Ping tools test network connectivity by sending ICMP echo requests and measuring response times to determine network reachability and performance."
	},
	"audience": {
		"@type": "Audience",
		"audienceType": "Network Administrators, System Administrators, IT Professionals, Network Engineers"
	}
}
</script>
