...
<section class="container my-4"><div class="row"><div class="col-lg-12"><div class="card"><div class="card-body">
  ...
  <p>Tracks mechanical energy (potential/kinetic) using SI units and highlights conservation principles (ignoring losses unless specified). Visualizes energy transfers across states.</p>
  <h3 class="h6 mt-2">Learning Outcomes</h3>
  <ul class="mb-2"><li>Differentiate kinetic and potential energy contributions.</li><li>Understand conservation in idealized systems.</li><li>Practice unit consistency and intuition building.</li></ul>
...
<script type="application/ld+json">
{
  ...
  "@type": "WebPage",
  "name": "Energy Conservation Tracker",
  "url": "https://8gwifi.org/energy-conservation-tracker.jsp",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Energy Conservation Tracker", "item": "https://8gwifi.org/energy-conservation-tracker.jsp"}
  ]
}
</script>
