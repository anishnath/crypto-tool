<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <div lang="en">
        ...
        <head>
            ...
            <title>Free Text to Graph Generator - ASCII Flowchart & Mermaid Alternative | 8gwifi.org</title>
            <meta name="description"
                content="Create ASCII flowcharts and diagrams from text. Free Mermaid & PlantUML alternative. Export to PNG/SVG/PDF. No login required. Works in browser." />
            <meta name="keywords"
                content="mermaid alternative, text to graph, ascii flowchart generator, graph easy online, diagram as code, text to diagram, plantuml alternative, ascii art diagram, text to flowchart, architecture diagram generator, readme diagram, documentation flowchart, system design diagram, graphviz online, dot to png, unicode box art, free diagram tool" />
            <meta name="robots" content="index,follow" />
            <meta name="author" content="Anish Nath" />
            <link rel="canonical" href="https://8gwifi.org/graph-easy.jsp" />

            <!-- Open Graph for social sharing -->
            <meta property="og:title" content="Free Text to Graph Generator - ASCII Flowchart & Mermaid Alternative" />
            <meta property="og:description"
                content="Create ASCII flowcharts and diagrams from text. Free Mermaid & PlantUML alternative. Export to PNG, SVG, PDF. No login required." />
            ...
            <meta name="twitter:title" content="Free Text to Graph Generator - ASCII Flowchart & Mermaid Alternative" />
            ...
            <script type="application/ld+json">
        {
            ...
            "alternateName": ["ASCII Flowchart Generator", "Graph-Easy Online", "Text to Flowchart Converter", "Mermaid Alternative"],
            ...
            "mainEntity": [
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Graph-Easy is a text-to-diagram tool that converts simple text notation into ASCII art flowcharts and graphs. Write [Node A] -> [Node B] and it automatically generates properly formatted diagrams with boxes, arrows, and connections."
                    }
                },
                {
                    "@type": "Question",
                        ...
                        <div class="container-fluid py-3" style="max-width: 1400px;">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <span class="info-badge"><i class="fas fa-project-diagram"></i>
                                            Flowcharts</span>
                                        ...
                                        <div class="card-body">
                                            <div class="form-section">
                                                <div class="form-section-title"><i
                                                        class="fas fa-pencil-alt me-1"></i>Enter Graph-Easy Notation
                                                </div>
...
[ Error ] -> [ Start ]</textarea>
                                            ...
                                            <div class="form-section">
                                                <div class="form-section-title"><i class="fas fa-cog me-1"></i>Output
                                                    Format</div>
                                            ...
                                            <button class="btn btn-block text-white" id="renderBtn" disabled
                                            ...
                                            <div class="mt-3">
                                                <small
                                                    class="text-muted d-block mb-2"><strong>Examples:</strong></small>
                                                <div class="d-flex flex-wrap gap-1">
                                                    ...
                                                    <button class="example-btn"
                                                        data-example="bidi">Bidirectional</button>
                                                    <button class="example-btn" data-example="labels">Edge
                                                        Labels</button>
                                                    <button class="example-btn" data-example="groups">Groups</button>
                                                    <button class="example-btn" data-example="selfloop">Self
                                                        Loop</button>
                                ...
                                <div class="col-lg-7 mb-3">
                                    <div class="card tool-card">
                                        <div
                                            ...
                                            <div class="d-flex gap-1">
                                                ...
                                                <div id="dotExportBtns" style="display: none;">
                                                    <button class="btn btn-sm btn-warning" id="exportPngBtn"
                                                        title="Export as PNG">
                                                        <i class="fas fa-file-image"></i> PNG
                                                    </button>
                                                    <button class="btn btn-sm btn-info" id="exportSvgBtn"
                                                        title="Export as SVG">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <textarea class="form-control" id="graphOutput" readonly
                                                placeholder="Rendered graph will appear here..."></textarea>
                            ...
                            <%@ include file="thanks.jsp" %>
                                ...
                                <div class="card tool-card mb-4">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0"><i class="fas fa-graduation-cap me-2"></i>Understanding
                                            Graph-Easy</h5>
                                    </div>
                                    <div class="card-body">
                                        <h6>What is Graph-Easy?</h6>
                                        <p>Graph-Easy is a Perl library that converts simple text notation into
                                            beautiful ASCII art diagrams. Originally created by Tels, it's widely used
                                            for documenting software architecture, creating flowcharts in documentation,
                                            and generating diagrams that can be embedded in plain text files like README
                                            files.</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                <div class="p-3 rounded h-100"
                                                    ...
                                                    <h6 class="text-center" style="color: #155724;"><strong>ASCII
                                                            Art</strong></h6>
                                                    <p class="small mb-0">Classic text-based diagrams using +, -, |, and
                                                        other ASCII characters. Works everywhere.</p>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <div class="p-3 rounded h-100"
                                                    style="background: #d1ecf1; border: 2px solid #17a2b8;">
                                                    <h6 class="text-center" style="color: #0c5460;"><strong>Box
                                                            Art</strong></h6>
                                                    <p class="small mb-0">Uses Unicode box-drawing characters for
                                                        cleaner, professional-looking diagrams.</p>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <div class="p-3 rounded h-100"
                                                    style="background: #fff3cd; border: 2px solid #ffc107;">
                                                    <h6 class="text-center" style="color: #856404;"><strong>GraphViz
                                                            DOT</strong> <span class="badge bg-warning text-dark"
                                                            style="font-size: 0.6rem;">Export</span></h6>
                                                    <p class="small mb-0">DOT format with <strong>PNG/SVG/PDF
                                                            export</strong> via Viz.js rendering.</p>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <div class="p-3 rounded h-100"
                                                    style="background: #e2e3ff; border: 2px solid #6366f1;">
                                                    <h6 class="text-center" style="color: #4338ca;">
                                                        <strong>HTML</strong> <span class="badge bg-primary"
                                                            style="font-size: 0.6rem;">Preview</span></h6>
                                                    <p class="small mb-0">HTML table output with <strong>live
                                                            preview</strong>. Toggle to view source code.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="small">
                                            <li><strong>Documentation:</strong> Create architecture diagrams that live
                                                alongside your code</li>
                                            <li><strong>README files:</strong> Add visual flowcharts to project
                                                documentation</li>
                                            <li><strong>System design:</strong> Quickly sketch component relationships
                                            </li>
                                            <li><strong>Process flows:</strong> Document workflows and decision trees
                                            </li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <pre
                                                    class="bg-dark text-light p-2 rounded small"><code>[ Input ] -> [ Process ] -> [ Output ]</code></pre>
                                            </div>
                                            <div class="col-md-6">
...
[ API ] -> [ Service ] -> [ DB ]</code></pre>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-sm table-bordered">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th>Feature</th>
                                                        <th style="background: var(--theme-light);">
                                                            <strong>Graph-Easy</strong></th>
                                                        <th>Mermaid</th>
                                                        <th>PlantUML</th>
                                                        <th>ASCII Flow</th>
                                                    </tr>
                                                ...
                                                <tbody class="small">
                                                    <tr>
                                                        ...
                                                        <td class="table-success"><i
                                                                class="fas fa-check text-success"></i>
                                                            <strong>Native</strong></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-success"><i
                                                                class="fas fa-check text-success"></i> Yes</td>
                                                        <td><i class="fas fa-check text-success"></i> Yes</td>
                                                        <td><i class="fas fa-check text-success"></i> Yes</td>
                                                        <td><i class="fas fa-times text-danger"></i> No</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-success"><i
                                                                class="fas fa-check text-success"></i> Browser only</td>
                                                        <td><i class="fas fa-check text-success"></i> Yes</td>
                                                    ...
                                                    <tr>
                                                        <td>Best For</td>
                                                        <td class="table-success"><strong>Docs, README,
                                                                Terminal</strong></td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-6 mb-2">
                                                <div class="text-center p-2 rounded"
                                                    ...
                                                    <i class="fas fa-code fa-2x mb-1"
                                                        style="color: var(--theme-primary);"></i>
                                            ...
                                            <div class="col-md-3 col-6 mb-2">
                                                <div class="text-center p-2 rounded"
                                                    style="background: var(--theme-light);">
                                                    <i class="fas fa-server fa-2x mb-1"
                                                        style="color: var(--theme-primary);"></i>
                                            ...
                                            <div class="col-md-3 col-6 mb-2">
                                                <div class="text-center p-2 rounded"
                                                    style="background: var(--theme-light);">
                                                    <i class="fas fa-book fa-2x mb-1"
                                                        style="color: var(--theme-primary);"></i>
                                            ...
                                            <div class="col-md-3 col-6 mb-2">
                                                <div class="text-center p-2 rounded"
                                                    style="background: var(--theme-light);">
                                                    <i class="fas fa-graduation-cap fa-2x mb-1"
                                                        style="color: var(--theme-primary);"></i>
                                        ...
                                        <div class="alert alert-info mt-4 small">
                                            ...
                                            <ul class="mb-0 mt-1">
                                                <li>Press <kbd>Ctrl</kbd>+<kbd>Enter</kbd> (or
                                                    <kbd>Cmd</kbd>+<kbd>Enter</kbd> on Mac) to quickly render your
                                                    graph.</li>
                                                <li>Select <strong>GraphViz DOT</strong> format to export your diagram
                                                    as PNG, SVG, or PDF.</li>
                                                <li>Select <strong>HTML</strong> format to see a live preview - toggle
                                                    between preview and source code.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="exportFilename"
                                                            class="form-label"><strong>Filename</strong></label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="exportFilename"
                                                                value="8gwifi-graph-data">
                                                            <span class="input-group-text"
                                                                id="exportExtension">.png</span>
                                                        </div>
                                                        <small class="text-muted">File will be saved as: <span
                                                                id="fullFilename">8gwifi-graph-data.png</span></small>
                                                    </div>
                                                    ...
                                                    <div class="alert alert-info small mb-3">
                                                        ...
                                                        <span id="exportInfo">Your graph will be exported as a
                                                            high-resolution image.</span>
                                                    </div>

                                                    <!-- Twitter Support Section -->
                                                    <div class="border rounded p-3 text-center"
                                                        style="background: linear-gradient(135deg, #e8f5fd 0%, #f0f9ff 100%);">
                                                        <p class="mb-2 small"><strong>Enjoying this free tool?</strong>
                                                            Show your support!</p>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn text-white" id="confirmExportBtn"
                                                        style="background: var(--theme-gradient);">
                                    ...
                                    <div class="modal fade" id="shareModal" tabindex="-1" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header"
                                                    style="background: var(--theme-gradient); color: white;">
                                                    <h5 class="modal-title"><i class="fas fa-share-alt me-2"></i>Share
                                                        This Tool</h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="text-center mb-4">
                                                        ...
                                                        <p class="text-muted small">Free online text-to-diagram
                                                            converter for flowcharts and architecture diagrams</p>
                                                    </div>

                                                    <!-- Share URL -->
                                                    <div class="mb-4">
                                                        <label class="form-label small"><strong>Share
                                                                URL</strong></label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="shareUrl"
                                                                value="https://8gwifi.org/graph-easy.jsp" readonly>
                                                    ...
                                                    <div class="border rounded p-3 text-center"
                                                        style="background: linear-gradient(135deg, #e8f5fd 0%, #f0f9ff 100%);">
                                                        <p class="mb-3"><strong><i class="fab fa-twitter me-1"
                                                                    style="color: #1DA1F2;"></i>Support on
                                                                Twitter</strong></p>
                                                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                                                            <a href="https://twitter.com/anish2good" target="_blank"
                                                                class="btn btn-sm text-white"
                                                        ...
                                                        <p class="mt-3 mb-0 small text-muted">Your support helps keep
                                                            this tool free!</p>
                                                    </div>

                                                    <!-- Other Share Options -->
                                                    <div class="mt-4">
                                                        <p class="small text-muted mb-2"><strong>More ways to
                                                                share:</strong></p>
                                                        <div class="d-flex justify-content-center gap-2">
                                                            <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://8gwifi.org/graph-easy.jsp"
                                                                target="_blank" class="btn btn-sm"
                                                                style="background: #0077b5; color: white;"
                                                                title="Share on LinkedIn">
                                                                <i class="fab fa-linkedin"></i>
                                                            </a>
                                                            <a href="https://www.reddit.com/submit?url=https://8gwifi.org/graph-easy.jsp&title=Free%20ASCII%20Diagram%20Generator%20-%20Text%20to%20Flowchart"
                                                                target="_blank" class="btn btn-sm"
                                                                style="background: #ff4500; color: white;"
                                                                title="Share on Reddit">
                                                                <i class="fab fa-reddit"></i>
                                                            </a>
                                                            <a href="https://news.ycombinator.com/submitlink?u=https://8gwifi.org/graph-easy.jsp&t=Graph-Easy%20Online%20-%20Free%20ASCII%20Diagram%20Generator"
                                                                target="_blank" class="btn btn-sm"
                                                                style="background: #ff6600; color: white;"
                                                                title="Share on Hacker News">
                                                                <i class="fab fa-hacker-news"></i>
                                                            </a>
                                                            <a href="mailto:?subject=Free%20ASCII%20Diagram%20Generator&body=Check%20out%20this%20free%20tool%20to%20create%20ASCII%20flowcharts%20and%20diagrams%3A%0A%0Ahttps%3A%2F%2F8gwifi.org%2Fgraph-easy.jsp"
