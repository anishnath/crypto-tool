...
<section class="container my-4"><div class="row"><div class="col-lg-12"><div class="card"><div class="card-body">
  ...
  <p>Visualizes geometric optics ray tracing for thin lenses and mirrors using standard sign conventions. Uses SI units and draws principal rays to show image formation.</p>
  <h3 class="h6 mt-2">Learning Outcomes</h3>
  <ul class="mb-2"><li>Interpret focal length, object distance, and image distance.</li><li>Understand upright/inverted and real/virtual images.</li><li>Practice sign conventions and units.</li></ul>
...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"WebPage","name":"Lens/Mirror Ray Tracer","url":"https://8gwifi.org/lens-mirror-ray-tracer.jsp","dateModified":"2025-11-19","author":{"@type":"Person","name":"Anish Nath","url":"https://x.com/anish2good"},"publisher":{"@type":"Organization","name":"8gwifi.org"}}
</script>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://8gwifi.org/"},{"@type":"ListItem","position":2,"name":"Lens/Mirror Ray Tracer","item":"https://8gwifi.org/lens-mirror-ray-tracer.jsp"}]}
</script>
