        ...
        <div class="collapse navbar-collapse" id="devopsToolsNavbar">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dockerDropdown" role="button" data-toggle="dropdown">
                ...
                <!-- Development Tools -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="devToolsDropdown" role="button" data-toggle="dropdown">
