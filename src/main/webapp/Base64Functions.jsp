...
<head>
	...
	<meta name="description" content="Decode from Base64 or Encode to Base64 - Here, with our simple online tool base64, decode, encode, online, tool" />
	...
	<script type="application/ld+json">
{
  ...
  "applicationCategory" : ["Base64 Encode","base64 decode","string base64 encode","string base64 decode"],
		...
		<section id="content">
			...
			<form id="form" method="POST">
				...
				<fieldset name="Online Base64 Functionality">
					...
					<p>Type Something</p>
					<font size="10" color="green"><div id="outputtext"> </div></font>
					<textarea name="inputtext" id="inputtext" cols="50" rows="10" placeholder="Type Soemthing The inputetext"></textarea>
				</fieldset>
