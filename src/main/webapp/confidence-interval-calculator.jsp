...
<main class="ms-main">
    ...
    <% request.setAttribute("activeService", "confidence"); %>
    ...
    <section class="ms-workspace">
        ...
        <header class="ms-title">
            <nav class="ms-crumbs">
                ...
                <span>/</span>
                <span aria-current="page">Confidence Interval</span>
            </nav>
            <h1>Confidence Interval Calculator</h1>
            <p class="ms-subtitle">Mean · proportion · two-sample · CI chart</p>
        </header>
...
<!-- Scripts -->
    ...
    <script src="<%=request.getContextPath()%>/js/confidence-interval-core.js?v=<%=v%>"></script>
...
<script>window.__MS_STAT_PAGE__ = { key: 'confidence', label: "Confidence Interval Calculator" };</script>
<%
